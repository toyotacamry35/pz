...
Shader "Colony_FX/Basic/S_MultipliedTextures_Additive_Merid" {
    Properties {
        ...
        _node_6278 ("node_6278", Range(0, 15)) = 0
    }
    SubShader {
        Tags {
...
////// Emissive:
                ...
                float3 emissive = (_col.rgb*(((_em*saturate(((pow(saturate(((_maskTex_copy.r*node_8430.r)*((pow(_pattern1_var.r,_pattern1_pow)*pow(_pattern2_var.r,_pattern2_pow))*_multCompensate))),_finalContrast)*pow(abs(dot(viewDirection,i.normalDir)),_node_6278))-i.uv1.g)))*i.vertexColor.rgb*i.vertexColor.a)/_softness));
