...
Shader "Custom/S_LitParticlesHaze"
{
	Properties
	{
		...
		_OpacityCorection("OpacityCorection", Float) = 1
	...
	SubShader
	{
		...
		#pragma target 4.0
		#pragma surface surf StandardCustomLighting alpha:fade keepalpha vertex:vertexDataFunc inalcolor:MyFinalColorFunc
...
#include "Assets/ASkyLighting/DeepSky Haze/Resources/DS_TransparentLib.cginc"
		...
		uniform float _OpacityCorection;
		...
		inline void MyFinalColorFunc(Input i, SurfaceOutputCustomLightingCustom o, inout fixed4 color) {
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			c.rgb = 0;
			c.a = saturate( ( temp_output_99_0 * distanceDepth87 * i.vertexColor.a ) );
			return c;
		}
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			float temp_output_152_0 = ( tex2DNode11.a * (0.0 + (grayscale44 - 0.0) * (1.0 - 0.0) / (1.0 - 0.0)) * _OpacityCorection * 3.0 );
			float4 color161 = IsGammaSpace() ? float4(0.01566394,0.07210226,0.3018868,1) : float4(0.001212379,0.006225322,0.07417665,1);
			float4 color159 = IsGammaSpace() ? float4(0,0,0,1) : float4(0,0,0,1);
			float4 lerpResult162 = lerp( color161 , color159 , temp_output_152_0);
			o.Emission = ( ( ( _TintColor * tex2DNode11 ) * i.vertexColor * 0.1 ) + temp_output_152_0 + ( lerpResult162 * 0.2 ) ).rgb;
		}
...
/*ASEBEGIN
Version=16900
2073;109;1206;774;3119.306;1275.187;6.68335;True;True
...
Node;AmplifyShaderEditor.SamplerNode;11;-74.18475,466.1626;Float;True;Property;_MainTex;MainTex;0;0;Create;True;0;0;False;0;None;6a15f088c01f0ed4198bc3ddc18b9617;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;155;167.967,893.4745;Float;False;Property;_OpacityCorection;OpacityCorection;3;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;153;178.9875,1032.294;Float;False;Constant;_Float4;Float 4;3;0;Create;True;0;0;False;0;3;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;98;17.81689,181.547;Float;False;Property;_TintColor;TintColor;2;0;Create;True;0;0;False;0;1,1,1,1;1,0.9952829,0.9952829,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;89;1141.34,2463.347;Float;False;Property;_SoftParticle;Soft Particle;1;0;Create;True;0;0;False;0;2;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;152;401.9236,812.0825;Float;False;4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;159;940.4157,1143.63;Float;False;Constant;_Color1;Color 1;4;0;Create;True;0;0;False;0;0,0,0,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;161;944.1196,959.4109;Float;False;Constant;_Color2;Color 2;4;0;Create;True;0;0;False;0;0.01566394,0.07210226,0.3018868,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LerpOp;162;1364.94,1008.742;Float;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;148;2611.966,669.4687;Float;True;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;104;3199.754,638.7478;Float;False;True;2;Float;ASEMaterialInspector;0;0;CustomLighting;Custom/S_LitParticlesHaze;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Transparent;0.5;True;False;0;False;Transparent;;Transparent;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;2;5;False;-1;10;False;-1;8;5;False;-1;1;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
WireConnection;44;0;22;0
WireConnection;54;0;44;0
WireConnection;152;0;11;4
...
ASEEND*/
//CHKSM=4D06F2CD0E98E10F454229DCCFC803E518D8A233