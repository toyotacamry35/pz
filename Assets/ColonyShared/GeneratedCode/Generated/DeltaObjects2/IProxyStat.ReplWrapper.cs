...
namespace GeneratedCode.DeltaObjects
{
    public partial class ProxyStat
    {
        ...
        private ProxyStatAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ProxyStatAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new ProxyStatAlways(this);
                return _Always_Wrap;
            }
        }

        private ProxyStatClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ProxyStatClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new ProxyStatClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private ProxyStatClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ProxyStatClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new ProxyStatClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private ProxyStatClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ProxyStatClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new ProxyStatClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private ProxyStatServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ProxyStatServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new ProxyStatServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private ProxyStatServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ProxyStatServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new ProxyStatServer(this);
                return _Server_Wrap;
            }
        }
    }
