...
namespace GeneratedCode.DeltaObjects
{
    public partial class BuildPlace
    {
        ...
        private BuildPlaceAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public BuildPlaceAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new BuildPlaceAlways(this);
                return _Always_Wrap;
            }
        }

        private BuildPlaceClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public BuildPlaceClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new BuildPlaceClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private BuildPlaceClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public BuildPlaceClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new BuildPlaceClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private BuildPlaceClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public BuildPlaceClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new BuildPlaceClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private BuildPlaceServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public BuildPlaceServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new BuildPlaceServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private BuildPlaceServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public BuildPlaceServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new BuildPlaceServer(this);
                return _Server_Wrap;
            }
        }
    }
