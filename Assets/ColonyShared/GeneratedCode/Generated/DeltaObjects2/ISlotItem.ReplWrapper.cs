...
namespace GeneratedCode.DeltaObjects
{
    public partial class SlotItem
    {
        ...
        private SlotItemAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public SlotItemAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new SlotItemAlways(this);
                return _Always_Wrap;
            }
        }

        private SlotItemClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public SlotItemClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new SlotItemClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private SlotItemClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public SlotItemClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new SlotItemClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private SlotItemClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public SlotItemClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new SlotItemClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private SlotItemServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public SlotItemServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new SlotItemServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private SlotItemServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public SlotItemServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new SlotItemServer(this);
                return _Server_Wrap;
            }
        }
    }
