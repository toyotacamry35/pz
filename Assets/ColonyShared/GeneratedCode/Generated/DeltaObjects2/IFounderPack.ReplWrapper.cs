...
namespace GeneratedCode.DeltaObjects
{
    public partial class FounderPack
    {
        ...
        private FounderPackAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public FounderPackAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new FounderPackAlways(this);
                return _Always_Wrap;
            }
        }

        private FounderPackClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public FounderPackClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new FounderPackClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private FounderPackClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public FounderPackClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new FounderPackClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private FounderPackClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public FounderPackClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new FounderPackClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private FounderPackServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public FounderPackServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new FounderPackServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private FounderPackServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public FounderPackServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new FounderPackServer(this);
                return _Server_Wrap;
            }
        }
    }
