...
namespace GeneratedCode.DeltaObjects.Chain
{
    ...
    public class WorldBoxChainProxy : BaseChainEntity
    {
        public WorldBoxChainProxy(SharedCode.Entities.IWorldBox entity): base(entity)
        {
        }

        public WorldBoxChainProxy(SharedCode.Entities.IWorldBox entity, IChainedEntity fromChain): base(entity, fromChain)
        {
        }

        public WorldBoxChainProxy NameSet(ChainArgument<string> value)
        {
        ...
        public WorldBoxChainProxy PrefabSet(ChainArgument<string> value)
        {
            var argumetRefs = new Dictionary<int, string>();
            var __id__ = SharedCode.EntitySystem.EntityPropertyResolvers.EntityPropertyResolver.GetPropertyAddress(__entity__);
            int offset = 0;
        ...
        public WorldBoxChainProxy Destroy()
        {
            var argumetRefs = new Dictionary<int, string>();
            var __id__ = SharedCode.EntitySystem.EntityPropertyResolvers.EntityPropertyResolver.GetPropertyAddress(__entity__);
            int offset = 0;
        ...
        public WorldBoxChainProxy GetOpenOuterRef(ChainArgument<ResourceSystem.Utils.OuterRef> oref)
        {
            var argumetRefs = new Dictionary<int, string>();
            var __id__ = SharedCode.EntitySystem.EntityPropertyResolvers.EntityPropertyResolver.GetPropertyAddress(__entity__);
            int offset = 0;
        ...
        public WorldBoxChainProxy Delay(float duration, bool repeat = false, bool fromUtcNow = true)
        {
            chainBatch.Chain.Add(new ChainBlockPeriod(duration, repeat ? -1 : 0, fromUtcNow));
            return this;
        }

        public WorldBoxChainProxy DelayCount(float duration, int count, bool fromUtcNow = true)
        {
            chainBatch.Chain.Add(new ChainBlockPeriod(duration, count, fromUtcNow));
            return this;
        }

        public WorldBoxChainProxy StoreResult(string name)
        {
    ...
    {
        public static WorldBoxChainProxy Chain(this SharedCode.Entities.IWorldBox entity)
        {
            return new WorldBoxChainProxy(entity);
        }

        public static WorldBoxChainProxy ContinueChain(this SharedCode.Entities.IWorldBox entity, IChainedEntity fromChain)
        {
            return new WorldBoxChainProxy(entity, fromChain);
        }
    }
}