...
namespace GeneratedCode.DeltaObjects
{
    public partial class CheatRelayServiceEntity
    {
        ...
        private CheatRelayServiceEntityAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CheatRelayServiceEntityAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new CheatRelayServiceEntityAlways(this);
                return _Always_Wrap;
            }
        }

        private CheatRelayServiceEntityClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CheatRelayServiceEntityClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new CheatRelayServiceEntityClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private CheatRelayServiceEntityClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CheatRelayServiceEntityClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new CheatRelayServiceEntityClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private CheatRelayServiceEntityClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CheatRelayServiceEntityClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new CheatRelayServiceEntityClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private CheatRelayServiceEntityServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CheatRelayServiceEntityServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new CheatRelayServiceEntityServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private CheatRelayServiceEntityServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CheatRelayServiceEntityServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new CheatRelayServiceEntityServer(this);
                return _Server_Wrap;
            }
        }
    }
