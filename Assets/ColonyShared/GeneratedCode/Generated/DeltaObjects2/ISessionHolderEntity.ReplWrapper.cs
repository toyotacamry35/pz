...
namespace GeneratedCode.DeltaObjects
{
    public partial class SessionHolderEntity
    {
        ...
        private SessionHolderEntityAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public SessionHolderEntityAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new SessionHolderEntityAlways(this);
                return _Always_Wrap;
            }
        }

        private SessionHolderEntityClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public SessionHolderEntityClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new SessionHolderEntityClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private SessionHolderEntityClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public SessionHolderEntityClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new SessionHolderEntityClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private SessionHolderEntityClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public SessionHolderEntityClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new SessionHolderEntityClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private SessionHolderEntityServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public SessionHolderEntityServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new SessionHolderEntityServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private SessionHolderEntityServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public SessionHolderEntityServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new SessionHolderEntityServer(this);
                return _Server_Wrap;
            }
        }
    }
