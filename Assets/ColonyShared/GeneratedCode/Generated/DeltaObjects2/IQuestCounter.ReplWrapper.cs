...
namespace GeneratedCode.DeltaObjects
{
    public partial class QuestCounter
    {
        ...
        private QuestCounterAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public QuestCounterAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new QuestCounterAlways(this);
                return _Always_Wrap;
            }
        }

        private QuestCounterClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public QuestCounterClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new QuestCounterClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private QuestCounterClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public QuestCounterClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new QuestCounterClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private QuestCounterClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public QuestCounterClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new QuestCounterClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private QuestCounterServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public QuestCounterServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new QuestCounterServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private QuestCounterServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public QuestCounterServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new QuestCounterServer(this);
                return _Server_Wrap;
            }
        }
    }
