...
namespace GeneratedCode.DeltaObjects.Chain
{
    ...
    public class WorldBenchChainProxy : BaseChainEntity
    {
        public WorldBenchChainProxy(SharedCode.Entities.IWorldBench entity): base(entity)
        {
        }

        public WorldBenchChainProxy(SharedCode.Entities.IWorldBench entity, IChainedEntity fromChain): base(entity, fromChain)
        {
        }

        public WorldBenchChainProxy NameSet(ChainArgument<string> value)
        {
        ...
        public WorldBenchChainProxy PrefabSet(ChainArgument<string> value)
        {
            var argumetRefs = new Dictionary<int, string>();
            var __id__ = SharedCode.EntitySystem.EntityPropertyResolvers.EntityPropertyResolver.GetPropertyAddress(__entity__);
            int offset = 0;
        ...
        public WorldBenchChainProxy GetOpenOuterRef(ChainArgument<ResourceSystem.Utils.OuterRef> oref)
        {
            var argumetRefs = new Dictionary<int, string>();
            var __id__ = SharedCode.EntitySystem.EntityPropertyResolvers.EntityPropertyResolver.GetPropertyAddress(__entity__);
            int offset = 0;
        ...
        public WorldBenchChainProxy Delay(float duration, bool repeat = false, bool fromUtcNow = true)
        {
            chainBatch.Chain.Add(new ChainBlockPeriod(duration, repeat ? -1 : 0, fromUtcNow));
            return this;
        }

        public WorldBenchChainProxy DelayCount(float duration, int count, bool fromUtcNow = true)
        {
            chainBatch.Chain.Add(new ChainBlockPeriod(duration, count, fromUtcNow));
            return this;
        }

        public WorldBenchChainProxy StoreResult(string name)
        {
    ...
    {
        public static WorldBenchChainProxy Chain(this SharedCode.Entities.IWorldBench entity)
        {
            return new WorldBenchChainProxy(entity);
        }

        public static WorldBenchChainProxy ContinueChain(this SharedCode.Entities.IWorldBench entity, IChainedEntity fromChain)
        {
            return new WorldBenchChainProxy(entity, fromChain);
        }
    }
}