...
namespace GeneratedCode.DeltaObjects
{
    public partial class InteractiveEntity
    {
        protected override void RandomFill(int __count__, System.Random __random__, bool __withReadOnly__)
        {
            ...
            {
                ((ResourcesSystem.Base.IHasRandomFill)Lootable)?.Fill(__count__, __random__, __withReadOnly__);
            }

            {
                ((ResourcesSystem.Base.IHasRandomFill)ComputableStateMachine)?.Fill(__count__, __random__, __withReadOnly__);
            }
            ...
            {
                ((ResourcesSystem.Base.IHasRandomFill)Lifespan)?.Fill(__count__, __random__, __withReadOnly__);
            }
