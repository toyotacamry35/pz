...
namespace GeneratedCode.DeltaObjects
{
    public partial class CharacterMovementSync
    {
        ...
        private CharacterMovementSyncAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CharacterMovementSyncAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new CharacterMovementSyncAlways(this);
                return _Always_Wrap;
            }
        }

        private CharacterMovementSyncClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CharacterMovementSyncClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new CharacterMovementSyncClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private CharacterMovementSyncClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CharacterMovementSyncClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new CharacterMovementSyncClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private CharacterMovementSyncClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CharacterMovementSyncClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new CharacterMovementSyncClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private CharacterMovementSyncServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CharacterMovementSyncServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new CharacterMovementSyncServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private CharacterMovementSyncServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CharacterMovementSyncServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new CharacterMovementSyncServer(this);
                return _Server_Wrap;
            }
        }
    }
