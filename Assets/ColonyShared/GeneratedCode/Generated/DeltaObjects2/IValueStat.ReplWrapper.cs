...
namespace GeneratedCode.DeltaObjects
{
    public partial class ValueStat
    {
        ...
        private ValueStatAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ValueStatAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new ValueStatAlways(this);
                return _Always_Wrap;
            }
        }

        private ValueStatClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ValueStatClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new ValueStatClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private ValueStatClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ValueStatClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new ValueStatClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private ValueStatClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ValueStatClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new ValueStatClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private ValueStatServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ValueStatServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new ValueStatServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private ValueStatServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ValueStatServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new ValueStatServer(this);
                return _Server_Wrap;
            }
        }
    }
