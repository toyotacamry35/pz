...
namespace GeneratedCode.DeltaObjects
{
    public partial class DialogEngine
    {
        protected override void RandomFill(int __count__, System.Random __random__, bool __withReadOnly__)
        {
            ...
            {
                var CurrentNode__rnd = ((ResourcesSystem.Loader.IGameResourcesRandomExtension)ResourcesSystem.Loader.GameResourcesHolder.Instance).LoadRandomResourceByType<ResourceSystem.Aspects.Dialog.DialogDef>(__random__);
                CurrentNode = CurrentNode__rnd;
            }
        }
    }
}