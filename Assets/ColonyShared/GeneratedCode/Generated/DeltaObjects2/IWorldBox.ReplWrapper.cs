...
namespace GeneratedCode.DeltaObjects
{
    public partial class WorldBox
    {
        ...
        private WorldBoxAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public WorldBoxAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new WorldBoxAlways(this);
                return _Always_Wrap;
            }
        }

        private WorldBoxClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public WorldBoxClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new WorldBoxClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private WorldBoxClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public WorldBoxClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new WorldBoxClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private WorldBoxClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public WorldBoxClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new WorldBoxClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private WorldBoxServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public WorldBoxServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new WorldBoxServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private WorldBoxServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public WorldBoxServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new WorldBoxServer(this);
                return _Server_Wrap;
            }
        }
    }
