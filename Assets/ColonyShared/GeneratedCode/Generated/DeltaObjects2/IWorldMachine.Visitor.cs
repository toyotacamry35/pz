...
namespace GeneratedCode.DeltaObjects
{
    public partial class WorldMachine
    {
        public override void Visit(System.Action<SharedCode.EntitySystem.IDeltaObject> visitor)
        {
            ...
            ((SharedCode.EntitySystem.IDeltaObjectExt)FuelContainer)?.Visit(visitor);
            ((SharedCode.EntitySystem.IDeltaObjectExt)OutputContainer)?.Visit(visitor);
            ((SharedCode.EntitySystem.IDeltaObjectExt)PriorityQueue)?.Visit(visitor);
            ...
            ((SharedCode.EntitySystem.IDeltaObjectExt)CraftProgressInfo)?.Visit(visitor);
