...
namespace GeneratedCode.DeltaObjects
{
    public partial class KnowledgeEngine
    {
        public override bool TryGetProperty<T>(int address, out T property)
        {
            ...
            {
                case 10:
                    property = (T)(object)KnownTechnologies;
                    return true;
                case 11:
                    property = (T)(object)KnownKnowledges;
                    return true;
                case 12:
                    property = (T)(object)ShownKnowledgeRecords;
                    return true;
                case 13:
        ...
        {
            if (childName == nameof(KnownTechnologies))
                return 10;
            if (childName == nameof(KnownKnowledges))
                return 11;
            if (childName == nameof(ShownKnowledgeRecords))
                return 12;
