...
namespace GeneratedCode.DeltaObjects.Chain
{
    ...
    public class CharacterChestChainProxy : BaseChainEntity
    {
        public CharacterChestChainProxy(SharedCode.Entities.ICharacterChest entity): base(entity)
        {
        }

        public CharacterChestChainProxy(SharedCode.Entities.ICharacterChest entity, IChainedEntity fromChain): base(entity, fromChain)
        {
        }

        public CharacterChestChainProxy NameSet(ChainArgument<string> value)
        {
        ...
        public CharacterChestChainProxy PrefabSet(ChainArgument<string> value)
        {
            var argumetRefs = new Dictionary<int, string>();
            var __id__ = SharedCode.EntitySystem.EntityPropertyResolvers.EntityPropertyResolver.GetPropertyAddress(__entity__);
            int offset = 0;
        ...
        public CharacterChestChainProxy GetOpenOuterRef(ChainArgument<ResourceSystem.Utils.OuterRef> oref)
        {
            var argumetRefs = new Dictionary<int, string>();
            var __id__ = SharedCode.EntitySystem.EntityPropertyResolvers.EntityPropertyResolver.GetPropertyAddress(__entity__);
            int offset = 0;
        ...
        public CharacterChestChainProxy GetIncomingDamageMultiplier()
        {
            var argumetRefs = new Dictionary<int, string>();
            var __id__ = SharedCode.EntitySystem.EntityPropertyResolvers.EntityPropertyResolver.GetPropertyAddress(__entity__);
            int offset = 0;
        ...
        public CharacterChestChainProxy Delay(float duration, bool repeat = false, bool fromUtcNow = true)
        {
            chainBatch.Chain.Add(new ChainBlockPeriod(duration, repeat ? -1 : 0, fromUtcNow));
            return this;
        }

        public CharacterChestChainProxy DelayCount(float duration, int count, bool fromUtcNow = true)
        {
            chainBatch.Chain.Add(new ChainBlockPeriod(duration, count, fromUtcNow));
            return this;
        }

        public CharacterChestChainProxy StoreResult(string name)
        {
    ...
    {
        public static CharacterChestChainProxy Chain(this SharedCode.Entities.ICharacterChest entity)
        {
            return new CharacterChestChainProxy(entity);
        }

        public static CharacterChestChainProxy ContinueChain(this SharedCode.Entities.ICharacterChest entity, IChainedEntity fromChain)
        {
            return new CharacterChestChainProxy(entity, fromChain);
        }
    }
}