...
namespace GeneratedCode.DeltaObjects
{
    public partial class BuildingPlace
    {
        ...
        private BuildingPlaceAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public BuildingPlaceAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new BuildingPlaceAlways(this);
                return _Always_Wrap;
            }
        }

        private BuildingPlaceClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public BuildingPlaceClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new BuildingPlaceClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private BuildingPlaceClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public BuildingPlaceClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new BuildingPlaceClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private BuildingPlaceClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public BuildingPlaceClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new BuildingPlaceClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private BuildingPlaceServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public BuildingPlaceServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new BuildingPlaceServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private BuildingPlaceServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public BuildingPlaceServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new BuildingPlaceServer(this);
                return _Server_Wrap;
            }
        }
    }
