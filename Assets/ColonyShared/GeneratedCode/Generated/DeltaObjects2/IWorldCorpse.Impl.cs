...
namespace GeneratedCode.DeltaObjects
{
    ...
    [MongoDB.Bson.Serialization.Attributes.BsonDiscriminator("WorldCorpse")]
    public partial class WorldCorpse : SharedCode.EntitySystem.BaseEntity, SharedCode.Entities.IWorldCorpse, IWorldCorpseImplementRemoteMethods
    {
        ...
        public WorldCorpse()
        {
            ...
            {
                VisibleOnlyForOwner = default(bool);
                ...
                LimitedLifetime = new GeneratedCode.DeltaObjects.LimitedLifetime();
        ...
        public WorldCorpse(System.Guid id): base(id)
        {
            if (!SharedCode.Serializers._SerializerContext.Pool.Current.Deserialization)
            {
                VisibleOnlyForOwner = default(bool);
        ...
        public override void GetAllLinkedEntities(long replicationMask, System.Collections.Generic.List<(long level, SharedCode.Refs.IEntityRef entityRef)> entities, long currentLevel, bool onlyDbEntities)
        {
            ...
            if ((replicationMask & (long)SharedCode.EntitySystem.ReplicationLevel.Master) == (long)SharedCode.EntitySystem.ReplicationLevel.Master)
                if (_LimitedLifetime != null)
                    ((SharedCode.EntitySystem.IDeltaObject)_LimitedLifetime).GetAllLinkedEntities(replicationMask, entities, currentLevel | (long)SharedCode.EntitySystem.ReplicationLevel.Master, onlyDbEntities);
        ...
        public override void FillReplicationSetRecursive(System.Collections.Generic.Dictionary<SharedCode.EntitySystem.ReplicationLevel, System.Collections.Generic.Dictionary<SharedCode.EntitySystem.IDeltaObject, SharedCode.EntitySystem.DeltaObjectReplicationInfo>> replicationSets, System.Collections.Generic.HashSet<SharedCode.EntitySystem.ReplicationLevel> traverseReplicationLevels, SharedCode.EntitySystem.ReplicationLevel currentLevel, bool withBsonIgnore)
        {
            ...
            GeneratedCode.EntitySystem.DeltaObjectHelper.FillReplicationSetRecursive(replicationSets, traverseReplicationLevels, _LimitedLifetime, currentLevel > SharedCode.EntitySystem.ReplicationLevel.Master ? currentLevel : SharedCode.EntitySystem.ReplicationLevel.Master, true, withBsonIgnore);
        ...
        public override void LinkChangedDeltaObjects(System.Collections.Generic.Dictionary<ulong, SharedCode.Serializers.Protobuf.DeserializedObjectInfo> deserializedObjects, SharedCode.EntitySystem.IEntity parentEntity)
        {
            ...
            GeneratedCode.EntitySystem.DeltaObjectHelper.LinkChangedDeltaObject(deserializedObjects, parentEntity, this, ref _AutoAddToWorldSpace, 18, false, SharedCode.EntitySystem.ReplicationLevel.Master);
            GeneratedCode.EntitySystem.DeltaObjectHelper.LinkChangedDeltaObject(deserializedObjects, parentEntity, this, ref _WorldSpaced, 19, false, SharedCode.EntitySystem.ReplicationLevel.Always);
            ...
            GeneratedCode.EntitySystem.DeltaObjectHelper.LinkChangedDeltaObject(deserializedObjects, parentEntity, this, ref _Doll, 21, false, SharedCode.EntitySystem.ReplicationLevel.ClientBroadcast);
            ...
            GeneratedCode.EntitySystem.DeltaObjectHelper.LinkChangedDeltaObject(deserializedObjects, parentEntity, this, ref _OwnerInformation, 23, false, SharedCode.EntitySystem.ReplicationLevel.Always);
            GeneratedCode.EntitySystem.DeltaObjectHelper.LinkChangedDeltaObject(deserializedObjects, parentEntity, this, ref _ContainerApi, 24, false, SharedCode.EntitySystem.ReplicationLevel.Always);
            GeneratedCode.EntitySystem.DeltaObjectHelper.LinkChangedDeltaObject(deserializedObjects, parentEntity, this, ref _LimitedLifetime, 25, false, SharedCode.EntitySystem.ReplicationLevel.Master);
            GeneratedCode.EntitySystem.DeltaObjectHelper.LinkChangedDeltaObject(deserializedObjects, parentEntity, this, ref _Destroyable, 26, false, SharedCode.EntitySystem.ReplicationLevel.Server);
        ...
        public override void IncrementParentRefs(SharedCode.EntitySystem.IEntity parentEntity, bool trackChanged)
        {
            ...
            if (ParentEntityRefCount == 1)
            {
                ...
                ((SharedCode.EntitySystem.IDeltaObjectExt)_LimitedLifetime)?.IncrementParentRefs(parentEntity, trackChanged);
        ...
        public override void ReplicationLevelActualize(SharedCode.EntitySystem.ReplicationLevel? actualParentLevel, SharedCode.EntitySystem.ReplicationLevel? oldParentLevel)
        {
            ...
            GeneratedCode.EntitySystem.DeltaObjectHelper.ReplicationLevelActualize(parentEntity, _LimitedLifetime, SharedCode.EntitySystem.ReplicationLevel.Master, actualParentLevel, oldParentLevel);
        ...
        public override void DecrementParentRefs()
        {
            ...
            if (!HasParentRef())
            {
                ...
                ((SharedCode.EntitySystem.IDeltaObjectExt)_LimitedLifetime)?.DecrementParentRefs();
        ...
        protected override void Subscribe(string propertyName, SharedCode.EntitySystem.PropertyChangedDelegate callback)
        {
            ...
            switch (propertyName)
            {
                case "VisibleOnlyForOwner":
                    VisibleOnlyForOwner__Changed += callback;
                    break;
                case "Def":
                ...
                case "LimitedLifetime":
                    LimitedLifetime__Changed += callback;
                    break;
                case "Destroyable":
        ...
        protected override void Unsubscribe(string propertyName)
        {
            ...
            {
                case "VisibleOnlyForOwner":
                    VisibleOnlyForOwner__Changed = null;
                    break;
                case "Def":
                    Def__Changed = null;
                    break;
        ...
        protected override void FireEvents(System.Collections.Generic.List<System.Func<System.Threading.Tasks.Task>> container)
        {
            ...
            if (NeedFireEvent(10) && VisibleOnlyForOwner__Changed != null)
            {
                ...
                var __Event__Args__ = new SharedCode.EntitySystem.EntityEventArgs(_VisibleOnlyForOwner, nameof(VisibleOnlyForOwner), __propAddress__, this);
                GeneratedCode.EntitySystem.EventHelper.FireEvent(container, __Event__Args__, VisibleOnlyForOwner__Changed);
            }
            ...
            if (NeedFireEvent(14) && Name__Changed != null)
            {
                SharedCode.EntitySystem.PropertyAddress __propAddress__ = SharedCode.EntitySystem.EntityPropertyResolvers.EntityPropertyResolver.GetPropertyAddress(this);
            ...
            if (NeedFireEvent(15) && Prefab__Changed != null)
            {
                SharedCode.EntitySystem.PropertyAddress __propAddress__ = SharedCode.EntitySystem.EntityPropertyResolvers.EntityPropertyResolver.GetPropertyAddress(this);
            ...
            if (NeedFireEvent(16) && SomeUnknownResourceThatMayBeUseful__Changed != null)
            {
                SharedCode.EntitySystem.PropertyAddress __propAddress__ = SharedCode.EntitySystem.EntityPropertyResolvers.EntityPropertyResolver.GetPropertyAddress(this);
            ...
            if (NeedFireEvent(17) && OnSceneObjectNetId__Changed != null)
            {
                SharedCode.EntitySystem.PropertyAddress __propAddress__ = SharedCode.EntitySystem.EntityPropertyResolvers.EntityPropertyResolver.GetPropertyAddress(this);
            ...
            if (NeedFireEvent(18) && AutoAddToWorldSpace__Changed != null)
            {
                SharedCode.EntitySystem.PropertyAddress __propAddress__ = SharedCode.EntitySystem.EntityPropertyResolvers.EntityPropertyResolver.GetPropertyAddress(this);
            ...
            if (NeedFireEvent(19) && WorldSpaced__Changed != null)
            {
                SharedCode.EntitySystem.PropertyAddress __propAddress__ = SharedCode.EntitySystem.EntityPropertyResolvers.EntityPropertyResolver.GetPropertyAddress(this);
            ...
            if (NeedFireEvent(21) && Doll__Changed != null)
            {
                SharedCode.EntitySystem.PropertyAddress __propAddress__ = SharedCode.EntitySystem.EntityPropertyResolvers.EntityPropertyResolver.GetPropertyAddress(this);
            ...
            if (NeedFireEvent(23) && OwnerInformation__Changed != null)
            {
                SharedCode.EntitySystem.PropertyAddress __propAddress__ = SharedCode.EntitySystem.EntityPropertyResolvers.EntityPropertyResolver.GetPropertyAddress(this);
            ...
            if (NeedFireEvent(24) && ContainerApi__Changed != null)
            {
                SharedCode.EntitySystem.PropertyAddress __propAddress__ = SharedCode.EntitySystem.EntityPropertyResolvers.EntityPropertyResolver.GetPropertyAddress(this);
            ...
            if (NeedFireEvent(25) && LimitedLifetime__Changed != null)
            {
                SharedCode.EntitySystem.PropertyAddress __propAddress__ = SharedCode.EntitySystem.EntityPropertyResolvers.EntityPropertyResolver.GetPropertyAddress(this);
                __propAddress__.DeltaObjectFieldId = 25;
                var __Event__Args__ = new SharedCode.EntitySystem.EntityEventArgs(_LimitedLifetime, nameof(LimitedLifetime), __propAddress__, this);
                GeneratedCode.EntitySystem.EventHelper.FireEvent(container, __Event__Args__, LimitedLifetime__Changed);
            }

            if (NeedFireEvent(26) && Destroyable__Changed != null)
            {
                SharedCode.EntitySystem.PropertyAddress __propAddress__ = SharedCode.EntitySystem.EntityPropertyResolvers.EntityPropertyResolver.GetPropertyAddress(this);
        ...
        public override void Downgrade(long mask)
        {
            ...
            if (((long)SharedCode.EntitySystem.ReplicationLevel.Master & mask) > 0)
                LimitedLifetime = default;
            if (_LimitedLifetime != null)
                ((SharedCode.EntitySystem.IDeltaObjectExt)_LimitedLifetime).Downgrade(mask);
