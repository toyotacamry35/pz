...
namespace GeneratedCode.DeltaObjects
{
    public partial class AccountTypeServiceEntity
    {
        ...
        private AccountTypeServiceEntityAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public AccountTypeServiceEntityAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new AccountTypeServiceEntityAlways(this);
                return _Always_Wrap;
            }
        }

        private AccountTypeServiceEntityClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public AccountTypeServiceEntityClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new AccountTypeServiceEntityClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private AccountTypeServiceEntityClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public AccountTypeServiceEntityClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new AccountTypeServiceEntityClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private AccountTypeServiceEntityClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public AccountTypeServiceEntityClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new AccountTypeServiceEntityClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private AccountTypeServiceEntityServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public AccountTypeServiceEntityServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new AccountTypeServiceEntityServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private AccountTypeServiceEntityServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public AccountTypeServiceEntityServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new AccountTypeServiceEntityServer(this);
                return _Server_Wrap;
            }
        }
    }
