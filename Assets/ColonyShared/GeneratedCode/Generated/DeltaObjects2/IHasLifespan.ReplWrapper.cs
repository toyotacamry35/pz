...
namespace GeneratedCode.DeltaObjects
{
    public partial class Lifespan
    {
        ...
        private LifespanAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public LifespanAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new LifespanAlways(this);
                return _Always_Wrap;
            }
        }

        private LifespanClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public LifespanClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new LifespanClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private LifespanClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public LifespanClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new LifespanClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private LifespanClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public LifespanClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new LifespanClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private LifespanServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public LifespanServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new LifespanServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private LifespanServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public LifespanServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new LifespanServer(this);
                return _Server_Wrap;
            }
        }
    }
