...
namespace GeneratedCode.DeltaObjects
{
    ...
    {
        public Task SetCacheValue(float value)
        {
            this.CheckValidateEntityInAsyncContext();
            if (this.IsMaster())
                if (this.NeedDeferredRpcOnMigrating())
                    return SetCacheValueRunMaster(value).AsTask();
                else
                    return SetCacheValueRun(value).AsTask();
            else
                return SendFuncs.SetCacheValue(value, this, this.GetNetworkProxyForSerialization(), this.EntitiesRepository, GetActualMigratingId()).AsTask();
        }

        private Func<Task> SetCacheValueCreateDeferredDelegate(float value) => () =>
        {
            return SetCacheValue(value);
        }

        ;
        public async ValueTask SetCacheValueRunMaster(float value)
        {
            if (parentEntity != null)
            {
                ...
                if (__checkTask__.Result)
                    await ((IEntityExt)parentEntity).AddDeferredMigratingRpc(SetCacheValueCreateDeferredDelegate(value), nameof(SetCacheValue));
            }

            await SetCacheValueRun(value);
        }

        public async ValueTask SetCacheValueRun(float value)
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(GeneratedCode.DeltaObjects.IInventoryWeightProxyStat), 0);
            var getTask = this.GetThisExclusive();
            var wrapper = getTask.IsCompleted ? getTask.Result : await getTask;
            using (wrapper)
            {
                if (wrapper == null && EntitiesRepository != null)
                    throw new Exception($"{nameof(SetCacheValue)} GetExclusive wrapper is null");
                ...
                try
                {
                    var returnTask = SetCacheValueImpl(value);
        ...
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(GeneratedCode.DeltaObjects.IInventoryWeightProxyStat), 1);
            var getTask = this.GetThisExclusive();
            var wrapper = getTask.IsCompleted ? getTask.Result : await getTask;
            using (wrapper)
            {
        ...
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(GeneratedCode.DeltaObjects.IInventoryWeightProxyStat), 2);
            var getTask = this.GetThisExclusive();
            var wrapper = getTask.IsCompleted ? getTask.Result : await getTask;
            using (wrapper)
            {
        ...
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(GeneratedCode.DeltaObjects.IInventoryWeightProxyStat), 3);
            var getTask = this.GetThisExclusive();
            var wrapper = getTask.IsCompleted ? getTask.Result : await getTask;
            using (wrapper)
            {
        ...
        {
            this.CheckValidateEntityInAsyncContext();
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(GeneratedCode.DeltaObjects.IInventoryWeightProxyStat), 4);
            Guid __oldMigrationId__ = default;
            var __needSetMigrationgId__ = MigratingId != Guid.Empty;
            if (__needSetMigrationgId__)
            {
