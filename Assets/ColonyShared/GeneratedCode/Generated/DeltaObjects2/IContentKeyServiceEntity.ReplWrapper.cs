...
namespace GeneratedCode.DeltaObjects
{
    public partial class ContentKeyServiceEntity
    {
        ...
        private ContentKeyServiceEntityAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ContentKeyServiceEntityAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new ContentKeyServiceEntityAlways(this);
                return _Always_Wrap;
            }
        }

        private ContentKeyServiceEntityClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ContentKeyServiceEntityClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new ContentKeyServiceEntityClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private ContentKeyServiceEntityClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ContentKeyServiceEntityClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new ContentKeyServiceEntityClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private ContentKeyServiceEntityClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ContentKeyServiceEntityClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new ContentKeyServiceEntityClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private ContentKeyServiceEntityServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ContentKeyServiceEntityServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new ContentKeyServiceEntityServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private ContentKeyServiceEntityServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ContentKeyServiceEntityServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new ContentKeyServiceEntityServer(this);
                return _Server_Wrap;
            }
        }
    }
