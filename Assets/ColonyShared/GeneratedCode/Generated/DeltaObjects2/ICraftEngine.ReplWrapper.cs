...
namespace GeneratedCode.DeltaObjects
{
    public partial class CraftEngine
    {
        ...
        private CraftEngineAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CraftEngineAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new CraftEngineAlways(this);
                return _Always_Wrap;
            }
        }

        private CraftEngineClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CraftEngineClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new CraftEngineClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private CraftEngineClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CraftEngineClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new CraftEngineClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private CraftEngineClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CraftEngineClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new CraftEngineClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private CraftEngineServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CraftEngineServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new CraftEngineServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private CraftEngineServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CraftEngineServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new CraftEngineServer(this);
                return _Server_Wrap;
            }
        }
    }
