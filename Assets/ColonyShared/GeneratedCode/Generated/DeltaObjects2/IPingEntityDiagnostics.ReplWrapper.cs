...
namespace GeneratedCode.DeltaObjects
{
    public partial class PingDiagnostics
    {
        ...
        private PingDiagnosticsAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public PingDiagnosticsAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new PingDiagnosticsAlways(this);
                return _Always_Wrap;
            }
        }

        private PingDiagnosticsClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public PingDiagnosticsClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new PingDiagnosticsClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private PingDiagnosticsClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public PingDiagnosticsClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new PingDiagnosticsClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private PingDiagnosticsClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public PingDiagnosticsClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new PingDiagnosticsClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private PingDiagnosticsServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public PingDiagnosticsServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new PingDiagnosticsServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private PingDiagnosticsServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public PingDiagnosticsServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new PingDiagnosticsServer(this);
                return _Server_Wrap;
            }
        }
    }
