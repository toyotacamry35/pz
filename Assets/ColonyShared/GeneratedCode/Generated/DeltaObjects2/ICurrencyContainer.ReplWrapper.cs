...
namespace GeneratedCode.DeltaObjects
{
    public partial class CurrencyContainer
    {
        ...
        private CurrencyContainerAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CurrencyContainerAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new CurrencyContainerAlways(this);
                return _Always_Wrap;
            }
        }

        private CurrencyContainerClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CurrencyContainerClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new CurrencyContainerClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private CurrencyContainerClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CurrencyContainerClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new CurrencyContainerClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private CurrencyContainerClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CurrencyContainerClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new CurrencyContainerClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private CurrencyContainerServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CurrencyContainerServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new CurrencyContainerServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private CurrencyContainerServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CurrencyContainerServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new CurrencyContainerServer(this);
                return _Server_Wrap;
            }
        }
    }
