...
namespace GeneratedCode.DeltaObjects
{
    public partial class SimpleWorldEntity
    {
        ...
        private SimpleWorldEntityAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public SimpleWorldEntityAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new SimpleWorldEntityAlways(this);
                return _Always_Wrap;
            }
        }

        private SimpleWorldEntityClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public SimpleWorldEntityClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new SimpleWorldEntityClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private SimpleWorldEntityClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public SimpleWorldEntityClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new SimpleWorldEntityClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private SimpleWorldEntityClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public SimpleWorldEntityClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new SimpleWorldEntityClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private SimpleWorldEntityServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public SimpleWorldEntityServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new SimpleWorldEntityServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private SimpleWorldEntityServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public SimpleWorldEntityServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new SimpleWorldEntityServer(this);
                return _Server_Wrap;
            }
        }
    }
