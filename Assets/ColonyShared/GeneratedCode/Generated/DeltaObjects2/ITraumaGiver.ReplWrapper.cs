...
namespace GeneratedCode.DeltaObjects
{
    public partial class TraumaGiver
    {
        ...
        private TraumaGiverAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public TraumaGiverAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new TraumaGiverAlways(this);
                return _Always_Wrap;
            }
        }

        private TraumaGiverClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public TraumaGiverClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new TraumaGiverClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private TraumaGiverClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public TraumaGiverClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new TraumaGiverClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private TraumaGiverClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public TraumaGiverClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new TraumaGiverClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private TraumaGiverServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public TraumaGiverServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new TraumaGiverServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private TraumaGiverServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public TraumaGiverServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new TraumaGiverServer(this);
                return _Server_Wrap;
            }
        }
    }
