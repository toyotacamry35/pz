...
namespace GeneratedCode.DeltaObjects
{
    public partial class ToucherTestEntity
    {
        ...
        private ToucherTestEntityAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ToucherTestEntityAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new ToucherTestEntityAlways(this);
                return _Always_Wrap;
            }
        }

        private ToucherTestEntityClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ToucherTestEntityClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new ToucherTestEntityClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private ToucherTestEntityClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ToucherTestEntityClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new ToucherTestEntityClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private ToucherTestEntityClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ToucherTestEntityClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new ToucherTestEntityClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private ToucherTestEntityServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ToucherTestEntityServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new ToucherTestEntityServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private ToucherTestEntityServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ToucherTestEntityServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new ToucherTestEntityServer(this);
                return _Server_Wrap;
            }
        }
    }
