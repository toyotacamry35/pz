...
namespace GeneratedCode.DeltaObjects
{
    public partial class ComputableStateMachine
    {
        ...
        private ComputableStateMachineAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ComputableStateMachineAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new ComputableStateMachineAlways(this);
                return _Always_Wrap;
            }
        }

        private ComputableStateMachineClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ComputableStateMachineClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new ComputableStateMachineClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private ComputableStateMachineClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ComputableStateMachineClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new ComputableStateMachineClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private ComputableStateMachineClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ComputableStateMachineClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new ComputableStateMachineClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private ComputableStateMachineServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ComputableStateMachineServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new ComputableStateMachineServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private ComputableStateMachineServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ComputableStateMachineServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new ComputableStateMachineServer(this);
                return _Server_Wrap;
            }
        }
    }
