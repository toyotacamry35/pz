...
namespace GeneratedCode.DeltaObjects
{
    public partial class WrapperCounter
    {
        ...
        private WrapperCounterAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public WrapperCounterAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new WrapperCounterAlways(this);
                return _Always_Wrap;
            }
        }

        private WrapperCounterClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public WrapperCounterClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new WrapperCounterClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private WrapperCounterClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public WrapperCounterClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new WrapperCounterClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private WrapperCounterClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public WrapperCounterClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new WrapperCounterClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private WrapperCounterServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public WrapperCounterServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new WrapperCounterServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private WrapperCounterServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public WrapperCounterServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new WrapperCounterServer(this);
                return _Server_Wrap;
            }
        }
    }
