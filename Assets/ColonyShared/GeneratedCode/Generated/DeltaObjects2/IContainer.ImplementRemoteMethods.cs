...
{
    public interface IContainerImplementRemoteMethods
    {
...
namespace GeneratedCode.DeltaObjects
{
    public interface IBuildingContainerImplementRemoteMethods
    {
        System.Threading.Tasks.Task<float> GetMaxWeigthImpl();
        System.Threading.Tasks.Task<float> GetTotalWeightImpl();
        System.Threading.Tasks.Task<int> GetMaxStackForSlotImpl(int destinationSlot);
...
namespace GeneratedCode.DeltaObjects
{
    public interface IMachineOutputContainerImplementRemoteMethods
    {
        System.Threading.Tasks.Task<float> GetMaxWeigthImpl();
        System.Threading.Tasks.Task<float> GetTotalWeightImpl();
        System.Threading.Tasks.Task<int> GetMaxStackForSlotImpl(int destinationSlot);
...
namespace GeneratedCode.DeltaObjects
{
    public interface IMachineFuelContainerImplementRemoteMethods
    {
        System.Threading.Tasks.Task<float> GetMaxWeigthImpl();
        System.Threading.Tasks.Task<float> GetTotalWeightImpl();
        System.Threading.Tasks.Task<int> GetMaxStackForSlotImpl(int destinationSlot);
