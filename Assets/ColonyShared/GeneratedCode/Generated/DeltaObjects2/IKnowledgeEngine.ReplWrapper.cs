...
namespace GeneratedCode.DeltaObjects
{
    public partial class KnowledgeEngine
    {
        ...
        private KnowledgeEngineAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public KnowledgeEngineAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new KnowledgeEngineAlways(this);
                return _Always_Wrap;
            }
        }

        private KnowledgeEngineClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public KnowledgeEngineClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new KnowledgeEngineClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private KnowledgeEngineClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public KnowledgeEngineClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new KnowledgeEngineClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private KnowledgeEngineClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public KnowledgeEngineClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new KnowledgeEngineClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private KnowledgeEngineServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public KnowledgeEngineServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new KnowledgeEngineServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private KnowledgeEngineServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public KnowledgeEngineServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new KnowledgeEngineServer(this);
                return _Server_Wrap;
            }
        }
    }
