...
namespace GeneratedCode.DeltaObjects
{
    public partial class ChainCallServiceEntityInternal
    {
        ...
        private ChainCallServiceEntityInternalAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ChainCallServiceEntityInternalAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new ChainCallServiceEntityInternalAlways(this);
                return _Always_Wrap;
            }
        }

        private ChainCallServiceEntityInternalClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ChainCallServiceEntityInternalClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new ChainCallServiceEntityInternalClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private ChainCallServiceEntityInternalClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ChainCallServiceEntityInternalClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new ChainCallServiceEntityInternalClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private ChainCallServiceEntityInternalClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ChainCallServiceEntityInternalClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new ChainCallServiceEntityInternalClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private ChainCallServiceEntityInternalServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ChainCallServiceEntityInternalServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new ChainCallServiceEntityInternalServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private ChainCallServiceEntityInternalServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ChainCallServiceEntityInternalServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new ChainCallServiceEntityInternalServer(this);
                return _Server_Wrap;
            }
        }
    }
