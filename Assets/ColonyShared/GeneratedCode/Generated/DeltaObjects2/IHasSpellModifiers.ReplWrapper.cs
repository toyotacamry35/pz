...
namespace GeneratedCode.DeltaObjects
{
    public partial class SpellModifiersCollector
    {
        ...
        private SpellModifiersCollectorAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public SpellModifiersCollectorAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new SpellModifiersCollectorAlways(this);
                return _Always_Wrap;
            }
        }

        private SpellModifiersCollectorClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public SpellModifiersCollectorClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new SpellModifiersCollectorClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private SpellModifiersCollectorClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public SpellModifiersCollectorClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new SpellModifiersCollectorClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private SpellModifiersCollectorClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public SpellModifiersCollectorClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new SpellModifiersCollectorClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private SpellModifiersCollectorServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public SpellModifiersCollectorServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new SpellModifiersCollectorServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private SpellModifiersCollectorServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public SpellModifiersCollectorServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new SpellModifiersCollectorServer(this);
                return _Server_Wrap;
            }
        }
    }
