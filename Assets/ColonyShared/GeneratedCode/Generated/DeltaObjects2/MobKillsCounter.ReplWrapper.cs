...
namespace GeneratedCode.DeltaObjects
{
    public partial class MobKillsCounter
    {
        ...
        private MobKillsCounterAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public MobKillsCounterAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new MobKillsCounterAlways(this);
                return _Always_Wrap;
            }
        }

        private MobKillsCounterClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public MobKillsCounterClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new MobKillsCounterClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private MobKillsCounterClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public MobKillsCounterClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new MobKillsCounterClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private MobKillsCounterClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public MobKillsCounterClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new MobKillsCounterClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private MobKillsCounterServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public MobKillsCounterServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new MobKillsCounterServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private MobKillsCounterServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public MobKillsCounterServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new MobKillsCounterServer(this);
                return _Server_Wrap;
            }
        }
    }
