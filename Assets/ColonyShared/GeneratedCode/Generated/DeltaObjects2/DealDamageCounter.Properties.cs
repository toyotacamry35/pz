...
namespace GeneratedCode.DeltaObjects
{
    public partial class DealDamageCounter
    {
        ...
        {
            get => GeneratedCode.EntitySystem.DeltaObjectHelper.GetDeltaObjField(parentEntity, ref _SumValue, false);
            set => GeneratedCode.EntitySystem.DeltaObjectHelper.SetDeltaObjField(parentEntity, this, ref _SumValue, value, SharedCode.EntitySystem.ReplicationLevel.Server, 10, false);
        }

        [Newtonsoft.Json.JsonIgnore]
        [ProtoBuf.ProtoMember(10, AsReference = false, DynamicType = false, OverwriteList = false)]
        public float SumValue__Serialized
        {
            get
            {
                return _SumValue;
            ...
            set
            {
                GeneratedCode.EntitySystem.DeltaObjectHelper.SetDeltaObjFieldFromSerialization(parentEntity, this, ref _SumValue, value, SharedCode.EntitySystem.ReplicationLevel.Server, 10, false);
            }
        }

        event SharedCode.EntitySystem.PropertyChangedDelegate SumValue__Changed;
        public string SumValue__ChangedSubscribers => GeneratedCode.EntitySystem.EventHelper.SubscribersToString(SumValue__Changed);
        [MongoDB.Bson.Serialization.Attributes.BsonIgnore]
        public bool SumValue__SerializedSpecified
        {
        ...
        [ProtoBuf.ProtoIgnore]
        [MongoDB.Bson.Serialization.Attributes.BsonIgnore]
        private float _SumValueForClient;
        [MongoDB.Bson.Serialization.Attributes.BsonIgnore]
        public float SumValueForClient
        {
            get => GeneratedCode.EntitySystem.DeltaObjectHelper.GetDeltaObjField(parentEntity, ref _SumValueForClient, false);
            set => GeneratedCode.EntitySystem.DeltaObjectHelper.SetDeltaObjField(parentEntity, this, ref _SumValueForClient, value, SharedCode.EntitySystem.ReplicationLevel.ClientFull, 11, false);
        }

        [Newtonsoft.Json.JsonIgnore]
        [ProtoBuf.ProtoMember(11, AsReference = false, DynamicType = false, OverwriteList = false)]
        public float SumValueForClient__Serialized
        {
            get
            {
                return _SumValueForClient;
            }

            set
            {
                GeneratedCode.EntitySystem.DeltaObjectHelper.SetDeltaObjFieldFromSerialization(parentEntity, this, ref _SumValueForClient, value, SharedCode.EntitySystem.ReplicationLevel.ClientFull, 11, false);
            }
        }

        event SharedCode.EntitySystem.PropertyChangedDelegate SumValueForClient__Changed;
        public string SumValueForClient__ChangedSubscribers => GeneratedCode.EntitySystem.EventHelper.SubscribersToString(SumValueForClient__Changed);
        [MongoDB.Bson.Serialization.Attributes.BsonIgnore]
        public bool SumValueForClient__SerializedSpecified
        {
