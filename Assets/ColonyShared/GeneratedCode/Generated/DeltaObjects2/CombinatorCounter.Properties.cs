...
namespace GeneratedCode.DeltaObjects
{
    public partial class CombinatorCounter
    {
        ...
        private SharedCode.EntitySystem.Delta.IDeltaList<GeneratedCode.DeltaObjects.IQuestCounterWrapper> _SubCounters;
        [MongoDB.Bson.Serialization.Attributes.BsonIgnore]
        public SharedCode.EntitySystem.Delta.IDeltaList<GeneratedCode.DeltaObjects.IQuestCounterWrapper> SubCounters
        {
            get => GeneratedCode.EntitySystem.DeltaObjectHelper.GetDeltaObjField(parentEntity, ref _SubCounters, false);
            set => GeneratedCode.EntitySystem.DeltaObjectHelper.SetDeltaObjField(parentEntity, this, ref _SubCounters, value, SharedCode.EntitySystem.ReplicationLevel.ClientFull, 10, false);
        }

        [Newtonsoft.Json.JsonIgnore]
        [ProtoBuf.ProtoMember(10, AsReference = true, DynamicType = true, OverwriteList = false)]
        public ulong? SubCounters__Serialized
        {
            get
            {
                return ((SharedCode.EntitySystem.IDeltaObjectExt)_SubCounters)?.LocalId;
            }
        ...
        event SharedCode.EntitySystem.PropertyChangedDelegate SubCounters__Changed;
        public string SubCounters__ChangedSubscribers => GeneratedCode.EntitySystem.EventHelper.SubscribersToString(SubCounters__Changed);
        [MongoDB.Bson.Serialization.Attributes.BsonIgnore]
        public bool SubCounters__SerializedSpecified
        {
...
namespace GeneratedCode.DeltaObjects
{
    public partial class QuestCounterWrapper
    {
        [ProtoBuf.ProtoIgnore]
        [MongoDB.Bson.Serialization.Attributes.BsonIgnore]
        private SharedCode.Entities.Engine.IQuestCounter _Counter;
        [MongoDB.Bson.Serialization.Attributes.BsonIgnore]
        public SharedCode.Entities.Engine.IQuestCounter Counter
        {
            get => GeneratedCode.EntitySystem.DeltaObjectHelper.GetDeltaObjField(parentEntity, ref _Counter, false);
            set => GeneratedCode.EntitySystem.DeltaObjectHelper.SetDeltaObjField(parentEntity, this, ref _Counter, value, SharedCode.EntitySystem.ReplicationLevel.ClientFull, 10, false);
        }

        [Newtonsoft.Json.JsonIgnore]
        [ProtoBuf.ProtoMember(10, AsReference = false, DynamicType = true, OverwriteList = false)]
        public ulong? Counter__Serialized
        {
            get
            {
                return ((SharedCode.EntitySystem.IDeltaObjectExt)_Counter)?.LocalId;
            }
