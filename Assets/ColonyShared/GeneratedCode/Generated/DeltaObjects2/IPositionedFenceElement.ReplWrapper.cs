...
namespace GeneratedCode.DeltaObjects
{
    public partial class PositionedFenceElement
    {
        ...
        private PositionedFenceElementAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public PositionedFenceElementAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new PositionedFenceElementAlways(this);
                return _Always_Wrap;
            }
        }

        private PositionedFenceElementClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public PositionedFenceElementClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new PositionedFenceElementClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private PositionedFenceElementClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public PositionedFenceElementClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new PositionedFenceElementClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private PositionedFenceElementClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public PositionedFenceElementClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new PositionedFenceElementClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private PositionedFenceElementServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public PositionedFenceElementServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new PositionedFenceElementServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private PositionedFenceElementServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public PositionedFenceElementServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new PositionedFenceElementServer(this);
                return _Server_Wrap;
            }
        }
    }
