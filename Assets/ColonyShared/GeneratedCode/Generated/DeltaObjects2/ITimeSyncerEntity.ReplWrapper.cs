...
namespace GeneratedCode.DeltaObjects
{
    public partial class TimeSyncerEntity
    {
        ...
        private TimeSyncerEntityAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public TimeSyncerEntityAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new TimeSyncerEntityAlways(this);
                return _Always_Wrap;
            }
        }

        private TimeSyncerEntityClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public TimeSyncerEntityClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new TimeSyncerEntityClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private TimeSyncerEntityClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public TimeSyncerEntityClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new TimeSyncerEntityClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private TimeSyncerEntityClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public TimeSyncerEntityClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new TimeSyncerEntityClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private TimeSyncerEntityServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public TimeSyncerEntityServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new TimeSyncerEntityServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private TimeSyncerEntityServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public TimeSyncerEntityServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new TimeSyncerEntityServer(this);
                return _Server_Wrap;
            }
        }
    }
