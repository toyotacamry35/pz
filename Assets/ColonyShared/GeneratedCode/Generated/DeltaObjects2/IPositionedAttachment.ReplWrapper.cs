...
namespace GeneratedCode.DeltaObjects
{
    public partial class PositionedAttachment
    {
        ...
        private PositionedAttachmentAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public PositionedAttachmentAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new PositionedAttachmentAlways(this);
                return _Always_Wrap;
            }
        }

        private PositionedAttachmentClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public PositionedAttachmentClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new PositionedAttachmentClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private PositionedAttachmentClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public PositionedAttachmentClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new PositionedAttachmentClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private PositionedAttachmentClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public PositionedAttachmentClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new PositionedAttachmentClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private PositionedAttachmentServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public PositionedAttachmentServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new PositionedAttachmentServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private PositionedAttachmentServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public PositionedAttachmentServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new PositionedAttachmentServer(this);
                return _Server_Wrap;
            }
        }
    }
