...
namespace GeneratedCode.DeltaObjects
{
    public partial class Lootable
    {
        ...
        private LootableAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public LootableAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new LootableAlways(this);
                return _Always_Wrap;
            }
        }

        private LootableClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public LootableClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new LootableClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private LootableClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public LootableClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new LootableClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private LootableClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public LootableClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new LootableClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private LootableServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public LootableServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new LootableServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private LootableServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public LootableServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new LootableServer(this);
                return _Server_Wrap;
            }
        }
    }
