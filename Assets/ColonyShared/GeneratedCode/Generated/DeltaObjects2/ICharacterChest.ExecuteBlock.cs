...
namespace GeneratedCode.DeltaObjects
{
    public partial class CharacterChest
    {
        ...
        {
            [SharedCode.EntitySystem.RpcMethodExecuteFuncAttribute(0, "ICharacterChest_NameSet_String_Message")]
            internal static async System.Threading.Tasks.Task NameSet_0(SharedCode.EntitySystem.IDeltaObject __deltaObj__, byte[] __data__, SharedCode.Entities.Core.IChainContext chainContext, string saveResultKey, System.Collections.Generic.Dictionary<int, string> argumentRefs)
            {
                ...
                var __result__ = await ((SharedCode.Entities.ICharacterChest)__deltaObj__).NameSet(value);
                if (!string.IsNullOrEmpty(saveResultKey))
                    await chainContext.SetContextValue(saveResultKey, __result__);
            }

            [SharedCode.EntitySystem.RpcMethodExecuteFuncAttribute(1, "ICharacterChest_PrefabSet_String_Message")]
            internal static async System.Threading.Tasks.Task PrefabSet_1(SharedCode.EntitySystem.IDeltaObject __deltaObj__, byte[] __data__, SharedCode.Entities.Core.IChainContext chainContext, string saveResultKey, System.Collections.Generic.Dictionary<int, string> argumentRefs)
            {
                ...
                string value;
                (value, __offset__) = await SharedCode.EntitySystem.ChainCalls.ChainCallHelpers.GetArg<string>(__data__, __offset__, 0, chainContext, argumentRefs);
                var __result__ = await ((SharedCode.Entities.ICharacterChest)__deltaObj__).PrefabSet(value);
                if (!string.IsNullOrEmpty(saveResultKey))
                    await chainContext.SetContextValue(saveResultKey, __result__);
            }

            [SharedCode.EntitySystem.RpcMethodExecuteFuncAttribute(2, "ICharacterChest_GetOpenOuterRef_OuterRef_Message")]
            internal static async System.Threading.Tasks.Task GetOpenOuterRef_2(SharedCode.EntitySystem.IDeltaObject __deltaObj__, byte[] __data__, SharedCode.Entities.Core.IChainContext chainContext, string saveResultKey, System.Collections.Generic.Dictionary<int, string> argumentRefs)
            {
                ...
                var __result__ = await ((SharedCode.Entities.ICharacterChest)__deltaObj__).GetOpenOuterRef(oref);
                if (!string.IsNullOrEmpty(saveResultKey))
                    await chainContext.SetContextValue(saveResultKey, __result__);
            }

            [SharedCode.EntitySystem.RpcMethodExecuteFuncAttribute(3, "ICharacterChest_GetIncomingDamageMultiplier__Message")]
            internal static async System.Threading.Tasks.Task GetIncomingDamageMultiplier_3(SharedCode.EntitySystem.IDeltaObject __deltaObj__, byte[] __data__, SharedCode.Entities.Core.IChainContext chainContext, string saveResultKey, System.Collections.Generic.Dictionary<int, string> argumentRefs)
            {
                var __result__ = await ((SharedCode.Entities.ICharacterChest)__deltaObj__).GetIncomingDamageMultiplier();
                if (!string.IsNullOrEmpty(saveResultKey))
                    await chainContext.SetContextValue(saveResultKey, __result__);
            }
        }
