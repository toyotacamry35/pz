...
namespace GeneratedCode.DeltaObjects
{
    public partial class Consumer
    {
        ...
        private ConsumerAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ConsumerAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new ConsumerAlways(this);
                return _Always_Wrap;
            }
        }

        private ConsumerClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ConsumerClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new ConsumerClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private ConsumerClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ConsumerClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new ConsumerClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private ConsumerClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ConsumerClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new ConsumerClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private ConsumerServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ConsumerServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new ConsumerServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private ConsumerServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ConsumerServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new ConsumerServer(this);
                return _Server_Wrap;
            }
        }
    }
