...
namespace GeneratedCode.DeltaObjects
{
    public partial class EntityObjects
    {
        ...
        private EntityObjectsAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public EntityObjectsAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new EntityObjectsAlways(this);
                return _Always_Wrap;
            }
        }

        private EntityObjectsClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public EntityObjectsClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new EntityObjectsClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private EntityObjectsClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public EntityObjectsClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new EntityObjectsClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private EntityObjectsClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public EntityObjectsClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new EntityObjectsClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private EntityObjectsServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public EntityObjectsServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new EntityObjectsServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private EntityObjectsServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public EntityObjectsServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new EntityObjectsServer(this);
                return _Server_Wrap;
            }
        }
    }
