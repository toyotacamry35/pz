...
namespace GeneratedCode.DeltaObjects
{
    public partial class InputActionHandlers
    {
        ...
        private InputActionHandlersAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public InputActionHandlersAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new InputActionHandlersAlways(this);
                return _Always_Wrap;
            }
        }

        private InputActionHandlersClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public InputActionHandlersClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new InputActionHandlersClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private InputActionHandlersClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public InputActionHandlersClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new InputActionHandlersClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private InputActionHandlersClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public InputActionHandlersClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new InputActionHandlersClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private InputActionHandlersServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public InputActionHandlersServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new InputActionHandlersServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private InputActionHandlersServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public InputActionHandlersServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new InputActionHandlersServer(this);
                return _Server_Wrap;
            }
        }
    }
