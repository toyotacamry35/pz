...
namespace GeneratedCode.DeltaObjects
{
    public partial class MapHostEntity
    {
        protected override void RandomFill(int __count__, System.Random __random__, bool __withReadOnly__)
        {
            ...
            {
                _HostedMaps.Clear();
                var HostedMapsitem0__rnd = ((ResourcesSystem.Loader.IGameResourcesRandomExtension)ResourcesSystem.Loader.GameResourcesHolder.Instance).LoadRandomResourceByType<GeneratedCode.Custom.Config.MapDef>(__random__);
                HostedMaps.Add(HostedMapsitem0__rnd);
            }
        }
    }
}