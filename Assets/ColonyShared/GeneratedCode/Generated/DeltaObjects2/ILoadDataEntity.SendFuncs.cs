...
namespace GeneratedCode.DeltaObjects
{
    public partial class LoadDataEntity
    {
        ...
        {
            public static ValueTask<byte[]> LoadEntity(int typeId, System.Guid entityId, IDeltaObject __entity__, INetworkProxy networkProxy, IEntitiesRepository __repository__, Guid migrationId)
            {
                int offset;
                ...
                try
                {
                    ...
                    return EntitySystem.RpcHelper.SendRequest<byte[]>(__buffer__, offset, typeof(SharedCode.Entities.Cloud.ILoadDataEntity), 0, SharedCode.Network.MessageSendOptions.ReliableOrdered, __guid__, networkProxy, SharedCode.EntitySystem.ServerCoreRuntimeParameters.RpcTimeoutSeconds, false);
                }
                finally
                {
