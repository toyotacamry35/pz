...
namespace GeneratedCode.DeltaObjects
{
    public partial class NumenServiceEntity
    {
        ...
        private NumenServiceEntityAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public NumenServiceEntityAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new NumenServiceEntityAlways(this);
                return _Always_Wrap;
            }
        }

        private NumenServiceEntityClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public NumenServiceEntityClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new NumenServiceEntityClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private NumenServiceEntityClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public NumenServiceEntityClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new NumenServiceEntityClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private NumenServiceEntityClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public NumenServiceEntityClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new NumenServiceEntityClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private NumenServiceEntityServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public NumenServiceEntityServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new NumenServiceEntityServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private NumenServiceEntityServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public NumenServiceEntityServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new NumenServiceEntityServer(this);
                return _Server_Wrap;
            }
        }
    }
