...
namespace GeneratedCode.DeltaObjects
{
    public partial class BuildingEngine
    {
        ...
        {
            public static ValueTask<SharedCode.Entities.Engine.BuildOperationResult> Build(SharedCode.EntitySystem.PropertyAddress address, int slodIds, SharedCode.Utils.Vector3 position, SharedCode.Utils.Quaternion rotation, IDeltaObject __entity__, INetworkProxy networkProxy, IEntitiesRepository __repository__, Guid migrationId)
            {
                int offset;
                ...
                try
                {
                    ...
                    return EntitySystem.RpcHelper.SendRequest<SharedCode.Entities.Engine.BuildOperationResult>(__buffer__, offset, typeof(SharedCode.Entities.Engine.IBuildingEngine), 0, SharedCode.Network.MessageSendOptions.ReliableOrdered, __guid__, networkProxy, SharedCode.EntitySystem.ServerCoreRuntimeParameters.RpcTimeoutSeconds, false);
                }
                finally
                {
