...
namespace GeneratedCode.DeltaObjects
{
    public partial class CraftCounter
    {
        ...
        private CraftCounterAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CraftCounterAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new CraftCounterAlways(this);
                return _Always_Wrap;
            }
        }

        private CraftCounterClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CraftCounterClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new CraftCounterClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private CraftCounterClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CraftCounterClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new CraftCounterClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private CraftCounterClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CraftCounterClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new CraftCounterClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private CraftCounterServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CraftCounterServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new CraftCounterServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private CraftCounterServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CraftCounterServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new CraftCounterServer(this);
                return _Server_Wrap;
            }
        }
    }
