...
namespace GeneratedCode.DeltaObjects
{
    ...
    [MongoDB.Bson.Serialization.Attributes.BsonDiscriminator("WorldPersonalMachineEngine")]
    public partial class WorldPersonalMachineEngine : SharedCode.EntitySystem.BaseDeltaObject, Assets.ColonyShared.SharedCode.Entities.Engine.IWorldPersonalMachineEngine, IWorldPersonalMachineEngineImplementRemoteMethods
    {
        public WorldPersonalMachineEngine()
        {
            if (!SharedCode.Serializers._SerializerContext.Pool.Current.Deserialization)
            {
                WorldPersonalMachines = new SharedCode.EntitySystem.Delta.DeltaDictionary<ResourceSystem.Utils.OuterRef, ResourceSystem.Utils.OuterRef>();
            }
        ...
        public override void GetAllLinkedEntities(long replicationMask, System.Collections.Generic.List<(long level, SharedCode.Refs.IEntityRef entityRef)> entities, long currentLevel, bool onlyDbEntities)
        {
            if ((replicationMask & (long)SharedCode.EntitySystem.ReplicationLevel.ClientFull) == (long)SharedCode.EntitySystem.ReplicationLevel.ClientFull)
                if (_WorldPersonalMachines != null)
                    ((SharedCode.EntitySystem.IDeltaObject)_WorldPersonalMachines).GetAllLinkedEntities(replicationMask, entities, currentLevel | (long)SharedCode.EntitySystem.ReplicationLevel.ClientFull, onlyDbEntities);
        ...
        public override void FillReplicationSetRecursive(System.Collections.Generic.Dictionary<SharedCode.EntitySystem.ReplicationLevel, System.Collections.Generic.Dictionary<SharedCode.EntitySystem.IDeltaObject, SharedCode.EntitySystem.DeltaObjectReplicationInfo>> replicationSets, System.Collections.Generic.HashSet<SharedCode.EntitySystem.ReplicationLevel> traverseReplicationLevels, SharedCode.EntitySystem.ReplicationLevel currentLevel, bool withBsonIgnore)
        {
            ...
            GeneratedCode.EntitySystem.DeltaObjectHelper.FillReplicationSetRecursive(replicationSets, traverseReplicationLevels, _WorldPersonalMachines, currentLevel > SharedCode.EntitySystem.ReplicationLevel.ClientFull ? currentLevel : SharedCode.EntitySystem.ReplicationLevel.ClientFull, true, withBsonIgnore);
        }
        ...
        public override void LinkChangedDeltaObjects(System.Collections.Generic.Dictionary<ulong, SharedCode.Serializers.Protobuf.DeserializedObjectInfo> deserializedObjects, SharedCode.EntitySystem.IEntity parentEntity)
        {
            ...
            GeneratedCode.EntitySystem.DeltaObjectHelper.LinkChangedDeltaObject(deserializedObjects, parentEntity, this, ref _WorldPersonalMachines, 10, false, SharedCode.EntitySystem.ReplicationLevel.ClientFull);
        }
        ...
        public override void IncrementParentRefs(SharedCode.EntitySystem.IEntity parentEntity, bool trackChanged)
        {
            ...
            {
                ((SharedCode.EntitySystem.IDeltaObjectExt)_WorldPersonalMachines)?.IncrementParentRefs(parentEntity, trackChanged);
            }
        }
        ...
        public override void ReplicationLevelActualize(SharedCode.EntitySystem.ReplicationLevel? actualParentLevel, SharedCode.EntitySystem.ReplicationLevel? oldParentLevel)
        {
            ...
            GeneratedCode.EntitySystem.DeltaObjectHelper.ReplicationLevelActualize(parentEntity, _WorldPersonalMachines, SharedCode.EntitySystem.ReplicationLevel.ClientFull, actualParentLevel, oldParentLevel);
        }
        ...
        public override void DecrementParentRefs()
        {
            ...
            if (!HasParentRef())
            {
                ((SharedCode.EntitySystem.IDeltaObjectExt)_WorldPersonalMachines)?.DecrementParentRefs();
            }
        }
        ...
        protected override void Subscribe(string propertyName, SharedCode.EntitySystem.PropertyChangedDelegate callback)
        {
            ...
            switch (propertyName)
            {
                case "WorldPersonalMachines":
                    WorldPersonalMachines__Changed += callback;
                    break;
                default:
        ...
        protected override void Unsubscribe(string propertyName)
        {
            ...
            {
                case "WorldPersonalMachines":
                    WorldPersonalMachines__Changed = null;
                    break;
                default:
                    throw new System.ArgumentException($"Field {propertyName} does not exist in {GetType()}", nameof(propertyName));
            }
        ...
        protected override void FireEvents(System.Collections.Generic.List<System.Func<System.Threading.Tasks.Task>> container)
        {
            ...
            if (NeedFireEvent(10) && WorldPersonalMachines__Changed != null)
            {
                ...
                var __Event__Args__ = new SharedCode.EntitySystem.EntityEventArgs(_WorldPersonalMachines, nameof(WorldPersonalMachines), __propAddress__, this);
                GeneratedCode.EntitySystem.EventHelper.FireEvent(container, __Event__Args__, WorldPersonalMachines__Changed);
            }
        }
        ...
        public override void Downgrade(long mask)
        {
            ...
            if (((long)SharedCode.EntitySystem.ReplicationLevel.ClientFull & mask) > 0)
                WorldPersonalMachines = default;
            if (_WorldPersonalMachines != null)
                ((SharedCode.EntitySystem.IDeltaObjectExt)_WorldPersonalMachines).Downgrade(mask);
        }
    }
}