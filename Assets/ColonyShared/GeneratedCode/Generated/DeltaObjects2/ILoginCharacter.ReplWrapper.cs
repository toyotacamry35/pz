...
namespace GeneratedCode.DeltaObjects
{
    public partial class LoginCharacter
    {
        ...
        private LoginCharacterAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public LoginCharacterAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new LoginCharacterAlways(this);
                return _Always_Wrap;
            }
        }

        private LoginCharacterClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public LoginCharacterClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new LoginCharacterClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private LoginCharacterClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public LoginCharacterClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new LoginCharacterClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private LoginCharacterClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public LoginCharacterClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new LoginCharacterClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private LoginCharacterServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public LoginCharacterServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new LoginCharacterServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private LoginCharacterServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public LoginCharacterServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new LoginCharacterServer(this);
                return _Server_Wrap;
            }
        }
    }
