...
namespace GeneratedCode.DeltaObjects
{
    public partial class TelemetryServiceEntity
    {
        ...
        private TelemetryServiceEntityAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public TelemetryServiceEntityAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new TelemetryServiceEntityAlways(this);
                return _Always_Wrap;
            }
        }

        private TelemetryServiceEntityClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public TelemetryServiceEntityClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new TelemetryServiceEntityClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private TelemetryServiceEntityClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public TelemetryServiceEntityClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new TelemetryServiceEntityClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private TelemetryServiceEntityClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public TelemetryServiceEntityClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new TelemetryServiceEntityClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private TelemetryServiceEntityServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public TelemetryServiceEntityServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new TelemetryServiceEntityServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private TelemetryServiceEntityServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public TelemetryServiceEntityServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new TelemetryServiceEntityServer(this);
                return _Server_Wrap;
            }
        }
    }
