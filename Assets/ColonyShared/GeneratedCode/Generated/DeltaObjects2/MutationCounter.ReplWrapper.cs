...
namespace GeneratedCode.DeltaObjects
{
    public partial class MutationCounter
    {
        ...
        private MutationCounterAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public MutationCounterAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new MutationCounterAlways(this);
                return _Always_Wrap;
            }
        }

        private MutationCounterClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public MutationCounterClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new MutationCounterClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private MutationCounterClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public MutationCounterClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new MutationCounterClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private MutationCounterClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public MutationCounterClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new MutationCounterClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private MutationCounterServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public MutationCounterServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new MutationCounterServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private MutationCounterServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public MutationCounterServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new MutationCounterServer(this);
                return _Server_Wrap;
            }
        }
    }
