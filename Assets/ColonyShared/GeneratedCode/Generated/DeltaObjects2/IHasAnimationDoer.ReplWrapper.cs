...
namespace GeneratedCode.DeltaObjects
{
    public partial class AnimationDoerOwner
    {
        ...
        private AnimationDoerOwnerAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public AnimationDoerOwnerAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new AnimationDoerOwnerAlways(this);
                return _Always_Wrap;
            }
        }

        private AnimationDoerOwnerClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public AnimationDoerOwnerClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new AnimationDoerOwnerClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private AnimationDoerOwnerClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public AnimationDoerOwnerClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new AnimationDoerOwnerClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private AnimationDoerOwnerClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public AnimationDoerOwnerClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new AnimationDoerOwnerClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private AnimationDoerOwnerServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public AnimationDoerOwnerServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new AnimationDoerOwnerServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private AnimationDoerOwnerServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public AnimationDoerOwnerServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new AnimationDoerOwnerServer(this);
                return _Server_Wrap;
            }
        }
    }
