...
namespace GeneratedCode.DeltaObjects
{
    public partial class CombinatorCounter
    {
        protected override void RandomFill(int __count__, System.Random __random__, bool __withReadOnly__)
        {
            ...
            {
                _SubCounters.Clear();
                var SubCountersitem0__rnd = GeneratedCode.EntitySystem.RandomFillHelper.CrateInstance<GeneratedCode.DeltaObjects.QuestCounterWrapper>();
                ((ResourcesSystem.Base.IHasRandomFill)SubCountersitem0__rnd)?.Fill(__count__, __random__, __withReadOnly__);
                SubCounters.Add(SubCountersitem0__rnd);
            }
...
namespace GeneratedCode.DeltaObjects
{
    public partial class QuestCounterWrapper
    {
        protected override void RandomFill(int __count__, System.Random __random__, bool __withReadOnly__)
        {
            ...
            var random = new System.Random(System.Guid.NewGuid().ToString().GetHashCode());
            {
                ((ResourcesSystem.Base.IHasRandomFill)Counter)?.Fill(__count__, __random__, __withReadOnly__);
            }
        }
    }
}