...
namespace GeneratedCode.DeltaObjects
{
    public partial class ToucherTestDeltaObject
    {
        ...
        private ToucherTestDeltaObjectAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ToucherTestDeltaObjectAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new ToucherTestDeltaObjectAlways(this);
                return _Always_Wrap;
            }
        }

        private ToucherTestDeltaObjectClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ToucherTestDeltaObjectClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new ToucherTestDeltaObjectClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private ToucherTestDeltaObjectClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ToucherTestDeltaObjectClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new ToucherTestDeltaObjectClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private ToucherTestDeltaObjectClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ToucherTestDeltaObjectClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new ToucherTestDeltaObjectClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private ToucherTestDeltaObjectServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ToucherTestDeltaObjectServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new ToucherTestDeltaObjectServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private ToucherTestDeltaObjectServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ToucherTestDeltaObjectServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new ToucherTestDeltaObjectServer(this);
                return _Server_Wrap;
            }
        }
    }
