...
{
    public interface ITemporaryPerksImplementRemoteMethods
    {
        System.Threading.Tasks.Task AddPerkSlotImpl(int slotId, SharedCode.Aspects.Item.Templates.ItemTypeResource perkSlotType);
        System.Threading.Tasks.Task RemovePerkSlotImpl(int slotId);
...
namespace GeneratedCode.DeltaObjects
{
    public interface IPermanentPerksImplementRemoteMethods
    {
        System.Threading.Tasks.Task AddPerkSlotImpl(int slotId, SharedCode.Aspects.Item.Templates.ItemTypeResource perkSlotType);
        System.Threading.Tasks.Task RemovePerkSlotImpl(int slotId);
        System.Threading.Tasks.Task<float> GetMaxWeigthImpl();
...
namespace GeneratedCode.DeltaObjects
{
    public interface ISavedPerksImplementRemoteMethods
    {
        System.Threading.Tasks.Task AddPerkSlotImpl(int slotId, SharedCode.Aspects.Item.Templates.ItemTypeResource perkSlotType);
        System.Threading.Tasks.Task RemovePerkSlotImpl(int slotId);
        System.Threading.Tasks.Task<float> GetMaxWeigthImpl();
