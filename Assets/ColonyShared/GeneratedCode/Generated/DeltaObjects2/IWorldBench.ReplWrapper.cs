...
namespace GeneratedCode.DeltaObjects
{
    public partial class WorldBench
    {
        ...
        private WorldBenchAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public WorldBenchAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new WorldBenchAlways(this);
                return _Always_Wrap;
            }
        }

        private WorldBenchClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public WorldBenchClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new WorldBenchClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private WorldBenchClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public WorldBenchClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new WorldBenchClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private WorldBenchClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public WorldBenchClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new WorldBenchClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private WorldBenchServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public WorldBenchServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new WorldBenchServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private WorldBenchServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public WorldBenchServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new WorldBenchServer(this);
                return _Server_Wrap;
            }
        }
    }
