...
namespace GeneratedCode.DeltaObjects
{
    public partial class WorldBaken
    {
        ...
        private long _ReadyTimeUTC0InMilliseconds;
        [MongoDB.Bson.Serialization.Attributes.BsonIgnore]
        public long ReadyTimeUTC0InMilliseconds
        {
            get => GeneratedCode.EntitySystem.DeltaObjectHelper.GetDeltaObjField(parentEntity, ref _ReadyTimeUTC0InMilliseconds, false);
            set => GeneratedCode.EntitySystem.DeltaObjectHelper.SetDeltaObjField(parentEntity, this, ref _ReadyTimeUTC0InMilliseconds, value, SharedCode.EntitySystem.ReplicationLevel.ClientBroadcast, 10, false);
        }

        [Newtonsoft.Json.JsonIgnore]
        [ProtoBuf.ProtoMember(10, AsReference = false, DynamicType = false, OverwriteList = false)]
        public long ReadyTimeUTC0InMilliseconds__Serialized
        {
            get
            {
                return _ReadyTimeUTC0InMilliseconds;
            }

            set
            {
                GeneratedCode.EntitySystem.DeltaObjectHelper.SetDeltaObjFieldFromSerialization(parentEntity, this, ref _ReadyTimeUTC0InMilliseconds, value, SharedCode.EntitySystem.ReplicationLevel.ClientBroadcast, 10, false);
            }
        }

        event SharedCode.EntitySystem.PropertyChangedDelegate ReadyTimeUTC0InMilliseconds__Changed;
        public string ReadyTimeUTC0InMilliseconds__ChangedSubscribers => GeneratedCode.EntitySystem.EventHelper.SubscribersToString(ReadyTimeUTC0InMilliseconds__Changed);
        [MongoDB.Bson.Serialization.Attributes.BsonIgnore]
        public bool ReadyTimeUTC0InMilliseconds__SerializedSpecified
        {
        ...
        public string Name
        {
            ...
            set => GeneratedCode.EntitySystem.DeltaObjectHelper.SetDeltaObjField(parentEntity, this, ref _Name, value, SharedCode.EntitySystem.ReplicationLevel.Always, 12, false);
        }
        ...
        public string Name__Serialized
        {
            ...
            set
            {
                GeneratedCode.EntitySystem.DeltaObjectHelper.SetDeltaObjFieldFromSerialization(parentEntity, this, ref _Name, value, SharedCode.EntitySystem.ReplicationLevel.Always, 12, false);
            }
        }
        ...
        public string Prefab
        {
            ...
            set => GeneratedCode.EntitySystem.DeltaObjectHelper.SetDeltaObjField(parentEntity, this, ref _Prefab, value, SharedCode.EntitySystem.ReplicationLevel.Always, 13, false);
        }
        ...
        public string Prefab__Serialized
        {
            ...
            set
            {
                GeneratedCode.EntitySystem.DeltaObjectHelper.SetDeltaObjFieldFromSerialization(parentEntity, this, ref _Prefab, value, SharedCode.EntitySystem.ReplicationLevel.Always, 13, false);
            }
        }
        ...
        public Assets.Src.ResourcesSystem.Base.ISaveableResource SomeUnknownResourceThatMayBeUseful
        {
            ...
            set => GeneratedCode.EntitySystem.DeltaObjectHelper.SetDeltaObjField(parentEntity, this, ref _SomeUnknownResourceThatMayBeUseful, value, SharedCode.EntitySystem.ReplicationLevel.Always, 14, false);
        }
        ...
        public Assets.Src.ResourcesSystem.Base.ISaveableResource SomeUnknownResourceThatMayBeUseful__Serialized
        {
            ...
            set
            {
                GeneratedCode.EntitySystem.DeltaObjectHelper.SetDeltaObjFieldFromSerialization(parentEntity, this, ref _SomeUnknownResourceThatMayBeUseful, value, SharedCode.EntitySystem.ReplicationLevel.Always, 14, false);
            }
        }
        ...
        public SharedCode.Entities.OnSceneObjectNetId OnSceneObjectNetId
        {
            ...
            set => GeneratedCode.EntitySystem.DeltaObjectHelper.SetDeltaObjField(parentEntity, this, ref _OnSceneObjectNetId, value, SharedCode.EntitySystem.ReplicationLevel.Always, 15, false);
        }
        ...
        public SharedCode.Entities.OnSceneObjectNetId OnSceneObjectNetId__Serialized
        {
            ...
            set
            {
                GeneratedCode.EntitySystem.DeltaObjectHelper.SetDeltaObjFieldFromSerialization(parentEntity, this, ref _OnSceneObjectNetId, value, SharedCode.EntitySystem.ReplicationLevel.Always, 15, false);
            }
        }
        ...
        public SharedCode.Entities.IAutoAddToWorldSpace AutoAddToWorldSpace
        {
            ...
            set => GeneratedCode.EntitySystem.DeltaObjectHelper.SetDeltaObjField(parentEntity, this, ref _AutoAddToWorldSpace, value, SharedCode.EntitySystem.ReplicationLevel.Master, 16, false);
        }
        ...
        public SharedCode.MovementSync.ISimpleMovementSync MovementSync
        {
            ...
            set => GeneratedCode.EntitySystem.DeltaObjectHelper.SetDeltaObjField(parentEntity, this, ref _MovementSync, value, SharedCode.EntitySystem.ReplicationLevel.Always, 18, false);
        }
        ...
        public SharedCode.Entities.IOwnerInformation OwnerInformation
        {
            ...
            set => GeneratedCode.EntitySystem.DeltaObjectHelper.SetDeltaObjField(parentEntity, this, ref _OwnerInformation, value, SharedCode.EntitySystem.ReplicationLevel.Always, 19, false);
        }
        ...
        public Assets.ColonyShared.SharedCode.Aspects.Damage.Templates.DamageMultiplierDef IncomingDamageMultiplier
        {
            ...
            set => GeneratedCode.EntitySystem.DeltaObjectHelper.SetDeltaObjField(parentEntity, this, ref _IncomingDamageMultiplier, value, SharedCode.EntitySystem.ReplicationLevel.Master, 24, false);
        }
        ...
        public Assets.ColonyShared.SharedCode.Aspects.Damage.Templates.DamageMultiplierDef IncomingDamageMultiplier__Serialized
        {
            ...
            set
            {
                GeneratedCode.EntitySystem.DeltaObjectHelper.SetDeltaObjFieldFromSerialization(parentEntity, this, ref _IncomingDamageMultiplier, value, SharedCode.EntitySystem.ReplicationLevel.Master, 24, false);
            }
        }
