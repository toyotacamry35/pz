...
namespace GeneratedCode.DeltaObjects
{
    public partial class AccumulatedStat
    {
        ...
        private AccumulatedStatAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public AccumulatedStatAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new AccumulatedStatAlways(this);
                return _Always_Wrap;
            }
        }

        private AccumulatedStatClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public AccumulatedStatClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new AccumulatedStatClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private AccumulatedStatClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public AccumulatedStatClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new AccumulatedStatClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private AccumulatedStatClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public AccumulatedStatClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new AccumulatedStatClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private AccumulatedStatServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public AccumulatedStatServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new AccumulatedStatServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private AccumulatedStatServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public AccumulatedStatServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new AccumulatedStatServer(this);
                return _Server_Wrap;
            }
        }
    }
