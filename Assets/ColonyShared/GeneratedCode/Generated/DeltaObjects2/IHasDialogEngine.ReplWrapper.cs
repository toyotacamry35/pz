...
namespace GeneratedCode.DeltaObjects
{
    public partial class DialogEngine
    {
        ...
        private DialogEngineAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public DialogEngineAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new DialogEngineAlways(this);
                return _Always_Wrap;
            }
        }

        private DialogEngineClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public DialogEngineClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new DialogEngineClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private DialogEngineClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public DialogEngineClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new DialogEngineClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private DialogEngineClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public DialogEngineClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new DialogEngineClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private DialogEngineServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public DialogEngineServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new DialogEngineServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private DialogEngineServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public DialogEngineServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new DialogEngineServer(this);
                return _Server_Wrap;
            }
        }
    }
