...
namespace GeneratedCode.DeltaObjects
{
    public partial class AuthorityOwner
    {
        ...
        private AuthorityOwnerAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public AuthorityOwnerAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new AuthorityOwnerAlways(this);
                return _Always_Wrap;
            }
        }

        private AuthorityOwnerClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public AuthorityOwnerClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new AuthorityOwnerClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private AuthorityOwnerClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public AuthorityOwnerClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new AuthorityOwnerClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private AuthorityOwnerClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public AuthorityOwnerClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new AuthorityOwnerClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private AuthorityOwnerServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public AuthorityOwnerServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new AuthorityOwnerServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private AuthorityOwnerServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public AuthorityOwnerServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new AuthorityOwnerServer(this);
                return _Server_Wrap;
            }
        }
    }
