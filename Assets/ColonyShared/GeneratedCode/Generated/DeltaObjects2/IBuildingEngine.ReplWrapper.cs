...
namespace GeneratedCode.DeltaObjects
{
    public partial class BuildingEngine
    {
        ...
        private BuildingEngineAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public BuildingEngineAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new BuildingEngineAlways(this);
                return _Always_Wrap;
            }
        }

        private BuildingEngineClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public BuildingEngineClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new BuildingEngineClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private BuildingEngineClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public BuildingEngineClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new BuildingEngineClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private BuildingEngineClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public BuildingEngineClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new BuildingEngineClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private BuildingEngineServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public BuildingEngineServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new BuildingEngineServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private BuildingEngineServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public BuildingEngineServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new BuildingEngineServer(this);
                return _Server_Wrap;
            }
        }
    }
