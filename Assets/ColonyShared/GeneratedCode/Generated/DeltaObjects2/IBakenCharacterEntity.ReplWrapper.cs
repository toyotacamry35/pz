...
namespace GeneratedCode.DeltaObjects
{
    public partial class BakenCharacterEntity
    {
        ...
        private BakenCharacterEntityAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public BakenCharacterEntityAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new BakenCharacterEntityAlways(this);
                return _Always_Wrap;
            }
        }

        private BakenCharacterEntityClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public BakenCharacterEntityClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new BakenCharacterEntityClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private BakenCharacterEntityClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public BakenCharacterEntityClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new BakenCharacterEntityClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private BakenCharacterEntityClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public BakenCharacterEntityClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new BakenCharacterEntityClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private BakenCharacterEntityServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public BakenCharacterEntityServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new BakenCharacterEntityServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private BakenCharacterEntityServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public BakenCharacterEntityServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new BakenCharacterEntityServer(this);
                return _Server_Wrap;
            }
        }
    }
