...
namespace GeneratedCode.DeltaObjects
{
    public partial class CharacterDoll
    {
        ...
        private CharacterDollAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CharacterDollAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new CharacterDollAlways(this);
                return _Always_Wrap;
            }
        }

        private CharacterDollClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CharacterDollClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new CharacterDollClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private CharacterDollClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CharacterDollClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new CharacterDollClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private CharacterDollClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CharacterDollClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new CharacterDollClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private CharacterDollServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CharacterDollServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new CharacterDollServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private CharacterDollServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CharacterDollServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new CharacterDollServer(this);
                return _Server_Wrap;
            }
        }
    }
