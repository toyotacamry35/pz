...
namespace GeneratedCode.DeltaObjects
{
    ...
    {
        public Task<bool> CanAddUsedSlot(Assets.Src.ResourcesSystem.Base.ResourceIDFull dollSlotRes)
        {
            this.CheckValidateEntityInAsyncContext();
            if (this.IsMaster())
                if (this.NeedDeferredRpcOnMigrating())
                    return CanAddUsedSlotRunMaster(dollSlotRes).AsTask();
                else
                    return CanAddUsedSlotRun(dollSlotRes).AsTask();
            else
                return SendFuncs.CanAddUsedSlot(dollSlotRes, this, this.GetNetworkProxyForSerialization(), this.EntitiesRepository, GetActualMigratingId()).AsTask();
        }

        private Func<Task<bool>> CanAddUsedSlotCreateDeferredDelegate(Assets.Src.ResourcesSystem.Base.ResourceIDFull dollSlotRes) => () =>
        {
            return CanAddUsedSlot(dollSlotRes);
        }

        ;
        public async ValueTask<bool> CanAddUsedSlotRunMaster(Assets.Src.ResourcesSystem.Base.ResourceIDFull dollSlotRes)
        {
            if (parentEntity != null)
            {
                ...
                if (__checkTask__.Result)
                    return await ((IEntityExt)parentEntity).AddDeferredMigratingRpc(CanAddUsedSlotCreateDeferredDelegate(dollSlotRes), nameof(CanAddUsedSlot));
            }

            return await CanAddUsedSlotRun(dollSlotRes);
        }

        public async ValueTask<bool> CanAddUsedSlotRun(Assets.Src.ResourcesSystem.Base.ResourceIDFull dollSlotRes)
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ICharacterDoll), 0);
            var getTask = this.GetThisExclusive();
            var wrapper = getTask.IsCompleted ? getTask.Result : await getTask;
            using (wrapper)
            {
                if (wrapper == null && EntitiesRepository != null)
                    throw new Exception($"{nameof(CanAddUsedSlot)} GetExclusive wrapper is null");
                ...
                try
                {
                    var returnTask = CanAddUsedSlotImpl(dollSlotRes);
        ...
        public Task<bool> AddUsedSlot(Assets.Src.ResourcesSystem.Base.ResourceIDFull dollSlotRes)
        {
            this.CheckValidateEntityInAsyncContext();
            if (this.IsMaster())
                if (this.NeedDeferredRpcOnMigrating())
        ...
        private Func<Task<bool>> AddUsedSlotCreateDeferredDelegate(Assets.Src.ResourcesSystem.Base.ResourceIDFull dollSlotRes) => () =>
        {
            return AddUsedSlot(dollSlotRes);
        }

        ;
        public async ValueTask<bool> AddUsedSlotRunMaster(Assets.Src.ResourcesSystem.Base.ResourceIDFull dollSlotRes)
        {
            if (parentEntity != null)
            {
                var __checkTask__ = ((IEntityExt)parentEntity).NeedPutToDeferredRpcQueue();
                if (!__checkTask__.IsCompleted)
                    await __checkTask__;
                if (__checkTask__.Result)
                    return await ((IEntityExt)parentEntity).AddDeferredMigratingRpc(AddUsedSlotCreateDeferredDelegate(dollSlotRes), nameof(AddUsedSlot));
            }

            return await AddUsedSlotRun(dollSlotRes);
        }

        public async ValueTask<bool> AddUsedSlotRun(Assets.Src.ResourcesSystem.Base.ResourceIDFull dollSlotRes)
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ICharacterDoll), 1);
            var getTask = this.GetThisExclusive();
            var wrapper = getTask.IsCompleted ? getTask.Result : await getTask;
            using (wrapper)
            {
        ...
        public Task<bool> RemoveUsedSlot(Assets.Src.ResourcesSystem.Base.ResourceIDFull dollSlotRes)
        {
            this.CheckValidateEntityInAsyncContext();
            if (this.IsMaster())
                if (this.NeedDeferredRpcOnMigrating())
        ...
        private Func<Task<bool>> RemoveUsedSlotCreateDeferredDelegate(Assets.Src.ResourcesSystem.Base.ResourceIDFull dollSlotRes) => () =>
        {
            return RemoveUsedSlot(dollSlotRes);
        }

        ;
        public async ValueTask<bool> RemoveUsedSlotRunMaster(Assets.Src.ResourcesSystem.Base.ResourceIDFull dollSlotRes)
        {
            if (parentEntity != null)
            {
                var __checkTask__ = ((IEntityExt)parentEntity).NeedPutToDeferredRpcQueue();
                if (!__checkTask__.IsCompleted)
                    await __checkTask__;
                if (__checkTask__.Result)
                    return await ((IEntityExt)parentEntity).AddDeferredMigratingRpc(RemoveUsedSlotCreateDeferredDelegate(dollSlotRes), nameof(RemoveUsedSlot));
            }

            return await RemoveUsedSlotRun(dollSlotRes);
        }

        public async ValueTask<bool> RemoveUsedSlotRun(Assets.Src.ResourcesSystem.Base.ResourceIDFull dollSlotRes)
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ICharacterDoll), 2);
            var getTask = this.GetThisExclusive();
            var wrapper = getTask.IsCompleted ? getTask.Result : await getTask;
            using (wrapper)
            {
        ...
        public ValueTask<bool> AddBlockedForUsageSlots(SharedCode.Aspects.Item.Templates.SlotDef[] slots)
        {
            this.CheckValidateEntityInAsyncContext();
            if (this.IsMaster())
                if (this.NeedDeferredRpcOnMigrating())
                    return AddBlockedForUsageSlotsRunMaster(slots);
                else
                    return AddBlockedForUsageSlotsRun(slots);
            else
                return SendFuncs.AddBlockedForUsageSlots(slots, this, this.GetNetworkProxyForSerialization(), this.EntitiesRepository, GetActualMigratingId());
        }

        private Func<Task<bool>> AddBlockedForUsageSlotsCreateDeferredDelegate(SharedCode.Aspects.Item.Templates.SlotDef[] slots) => () =>
        {
            return AddBlockedForUsageSlots(slots).AsTask();
        }

        ;
        public async ValueTask<bool> AddBlockedForUsageSlotsRunMaster(SharedCode.Aspects.Item.Templates.SlotDef[] slots)
        {
            if (parentEntity != null)
            {
                var __checkTask__ = ((IEntityExt)parentEntity).NeedPutToDeferredRpcQueue();
                if (!__checkTask__.IsCompleted)
                    await __checkTask__;
                if (__checkTask__.Result)
                    return await ((IEntityExt)parentEntity).AddDeferredMigratingRpc(AddBlockedForUsageSlotsCreateDeferredDelegate(slots), nameof(AddBlockedForUsageSlots));
            }

            return await AddBlockedForUsageSlotsRun(slots);
        }

        public async ValueTask<bool> AddBlockedForUsageSlotsRun(SharedCode.Aspects.Item.Templates.SlotDef[] slots)
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ICharacterDoll), 3);
            var getTask = this.GetThisExclusive();
            var wrapper = getTask.IsCompleted ? getTask.Result : await getTask;
            using (wrapper)
            {
                if (wrapper == null && EntitiesRepository != null)
                    throw new Exception($"{nameof(AddBlockedForUsageSlots)} GetExclusive wrapper is null");
                GeneratedCode.Manual.Repositories.RpcCurrentObject.ThisObj = this;
                Guid __oldMigrationId__ = default;
                var __needSetMigrationgId__ = MigratingId != Guid.Empty;
                if (__needSetMigrationgId__)
                ...
                try
                {
                    var returnTask = AddBlockedForUsageSlotsImpl(slots);
                    if (!returnTask.IsCompleted || returnTask.IsFaulted)
                    {
                        var __needDecrement__ = IncrementExecutedMethodsCounter(out var __parentEntity__);
                        try
        ...
        public ValueTask<bool> RemoveBlockedForUsageSlots(SharedCode.Aspects.Item.Templates.SlotDef[] slots)
        {
            this.CheckValidateEntityInAsyncContext();
            if (this.IsMaster())
                if (this.NeedDeferredRpcOnMigrating())
                    return RemoveBlockedForUsageSlotsRunMaster(slots);
                else
                    return RemoveBlockedForUsageSlotsRun(slots);
            else
                return SendFuncs.RemoveBlockedForUsageSlots(slots, this, this.GetNetworkProxyForSerialization(), this.EntitiesRepository, GetActualMigratingId());
        }

        private Func<Task<bool>> RemoveBlockedForUsageSlotsCreateDeferredDelegate(SharedCode.Aspects.Item.Templates.SlotDef[] slots) => () =>
        {
            return RemoveBlockedForUsageSlots(slots).AsTask();
        }

        ;
        public async ValueTask<bool> RemoveBlockedForUsageSlotsRunMaster(SharedCode.Aspects.Item.Templates.SlotDef[] slots)
        {
            if (parentEntity != null)
            {
                var __checkTask__ = ((IEntityExt)parentEntity).NeedPutToDeferredRpcQueue();
                if (!__checkTask__.IsCompleted)
                    await __checkTask__;
                if (__checkTask__.Result)
                    return await ((IEntityExt)parentEntity).AddDeferredMigratingRpc(RemoveBlockedForUsageSlotsCreateDeferredDelegate(slots), nameof(RemoveBlockedForUsageSlots));
            }

            return await RemoveBlockedForUsageSlotsRun(slots);
        }

        public async ValueTask<bool> RemoveBlockedForUsageSlotsRun(SharedCode.Aspects.Item.Templates.SlotDef[] slots)
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ICharacterDoll), 4);
            var getTask = this.GetThisExclusive();
            var wrapper = getTask.IsCompleted ? getTask.Result : await getTask;
            using (wrapper)
            {
                if (wrapper == null && EntitiesRepository != null)
                    throw new Exception($"{nameof(RemoveBlockedForUsageSlots)} GetExclusive wrapper is null");
                GeneratedCode.Manual.Repositories.RpcCurrentObject.ThisObj = this;
                Guid __oldMigrationId__ = default;
                var __needSetMigrationgId__ = MigratingId != Guid.Empty;
                if (__needSetMigrationgId__)
                ...
                try
                {
                    var returnTask = RemoveBlockedForUsageSlotsImpl(slots);
                    if (!returnTask.IsCompleted || returnTask.IsFaulted)
                    {
                        var __needDecrement__ = IncrementExecutedMethodsCounter(out var __parentEntity__);
                        try
        ...
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ICharacterDoll), 5);
            Guid __oldMigrationId__ = default;
            var __needSetMigrationgId__ = MigratingId != Guid.Empty;
            if (__needSetMigrationgId__)
            {
        ...
        {
            this.CheckValidateEntityInAsyncContext();
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ICharacterDoll), 6);
            Guid __oldMigrationId__ = default;
            var __needSetMigrationgId__ = MigratingId != Guid.Empty;
            if (__needSetMigrationgId__)
            {
        ...
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ICharacterDoll), 7);
            Guid __oldMigrationId__ = default;
            var __needSetMigrationgId__ = MigratingId != Guid.Empty;
            if (__needSetMigrationgId__)
            {
        ...
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ICharacterDoll), 8);
            Guid __oldMigrationId__ = default;
            var __needSetMigrationgId__ = MigratingId != Guid.Empty;
            if (__needSetMigrationgId__)
            {
        ...
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ICharacterDoll), 9);
            Guid __oldMigrationId__ = default;
            var __needSetMigrationgId__ = MigratingId != Guid.Empty;
            if (__needSetMigrationgId__)
            {
        ...
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ICharacterDoll), 10);
        ...
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ICharacterDoll), 11);
            global::GeneratedCode.Manual.Repositories.RpcCurrentObject.ThisObj = this;
            Guid __oldMigrationId__ = default;
            var __needSetMigrationgId__ = MigratingId != Guid.Empty;
            if (__needSetMigrationgId__)
        ...
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ICharacterDoll), 12);
            var getTask = this.GetThisExclusive();
            var wrapper = getTask.IsCompleted ? getTask.Result : await getTask;
            using (wrapper)
            {
        ...
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ICharacterDoll), 13);
            var getTask = this.GetThisExclusive();
            var wrapper = getTask.IsCompleted ? getTask.Result : await getTask;
            using (wrapper)
            {
        ...
        public async Task OnItemAddedToContainer(SharedCode.Aspects.Item.Templates.BaseItemResource arg1, int arg2, int arg3, bool arg4)
        {
            if (this.IsMaster())
            {
                GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ICharacterDoll), 14);
                INetworkProxy[] __networkProxies__ = this.GatherMessageTargets(SharedCode.EntitySystem.ReplicationLevel.ClientFull, typeof(SharedCode.DeltaObjects.ICharacterDoll), 14).ToArray();
        ...
        public async Task OnItemRemovedToContainer(SharedCode.Aspects.Item.Templates.BaseItemResource arg1, int arg2, int arg3, bool arg4)
        {
            if (this.IsMaster())
            {
                GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ICharacterDoll), 15);
                INetworkProxy[] __networkProxies__ = this.GatherMessageTargets(SharedCode.EntitySystem.ReplicationLevel.ClientFull, typeof(SharedCode.DeltaObjects.ICharacterDoll), 15).ToArray();
                if (__networkProxies__.Length > 0)
