...
namespace GeneratedCode.DeltaObjects
{
    ...
    [MongoDB.Bson.Serialization.Attributes.BsonDiscriminator("AccountTypeServiceEntity")]
    public partial class AccountTypeServiceEntity : SharedCode.EntitySystem.BaseEntity, SharedCode.Entities.Service.IAccountTypeServiceEntity, IAccountTypeServiceEntityImplementRemoteMethods
    {
        public override string CodeVersion => ThisAssembly.AssemblyInformationalVersion;
        public AccountTypeServiceEntity()
        {
            if (!SharedCode.Serializers._SerializerContext.Pool.Current.Deserialization)
            {
                AccountTypes = new SharedCode.EntitySystem.Delta.DeltaDictionary<System.Guid, long>();
            }

            constructor();
        }

        public AccountTypeServiceEntity(System.Guid id): base(id)
        {
            if (!SharedCode.Serializers._SerializerContext.Pool.Current.Deserialization)
            {
                AccountTypes = new SharedCode.EntitySystem.Delta.DeltaDictionary<System.Guid, long>();
        ...
        public override void GetAllLinkedEntities(long replicationMask, System.Collections.Generic.List<(long level, SharedCode.Refs.IEntityRef entityRef)> entities, long currentLevel, bool onlyDbEntities)
        {
            if ((replicationMask & (long)SharedCode.EntitySystem.ReplicationLevel.Server) == (long)SharedCode.EntitySystem.ReplicationLevel.Server)
                if (_AccountTypes != null)
                    ((SharedCode.EntitySystem.IDeltaObject)_AccountTypes).GetAllLinkedEntities(replicationMask, entities, currentLevel | (long)SharedCode.EntitySystem.ReplicationLevel.Server, onlyDbEntities);
        ...
        public override void FillReplicationSetRecursive(System.Collections.Generic.Dictionary<SharedCode.EntitySystem.ReplicationLevel, System.Collections.Generic.Dictionary<SharedCode.EntitySystem.IDeltaObject, SharedCode.EntitySystem.DeltaObjectReplicationInfo>> replicationSets, System.Collections.Generic.HashSet<SharedCode.EntitySystem.ReplicationLevel> traverseReplicationLevels, SharedCode.EntitySystem.ReplicationLevel currentLevel, bool withBsonIgnore)
        {
            ...
            GeneratedCode.EntitySystem.DeltaObjectHelper.FillReplicationSetRecursive(replicationSets, traverseReplicationLevels, _AccountTypes, currentLevel > SharedCode.EntitySystem.ReplicationLevel.Server ? currentLevel : SharedCode.EntitySystem.ReplicationLevel.Server, true, withBsonIgnore);
        }
        ...
        public override void LinkChangedDeltaObjects(System.Collections.Generic.Dictionary<ulong, SharedCode.Serializers.Protobuf.DeserializedObjectInfo> deserializedObjects, SharedCode.EntitySystem.IEntity parentEntity)
        {
            ...
            GeneratedCode.EntitySystem.DeltaObjectHelper.LinkChangedDeltaObject(deserializedObjects, parentEntity, this, ref _AccountTypes, 10, false, SharedCode.EntitySystem.ReplicationLevel.Server);
        }
        ...
        public override void IncrementParentRefs(SharedCode.EntitySystem.IEntity parentEntity, bool trackChanged)
        {
            ...
            {
                ((SharedCode.EntitySystem.IDeltaObjectExt)_AccountTypes)?.IncrementParentRefs(parentEntity, trackChanged);
            }
        }
        ...
        public override void ReplicationLevelActualize(SharedCode.EntitySystem.ReplicationLevel? actualParentLevel, SharedCode.EntitySystem.ReplicationLevel? oldParentLevel)
        {
            ...
            GeneratedCode.EntitySystem.DeltaObjectHelper.ReplicationLevelActualize(parentEntity, _AccountTypes, SharedCode.EntitySystem.ReplicationLevel.Server, actualParentLevel, oldParentLevel);
        }
        ...
        public override void DecrementParentRefs()
        {
            ...
            if (!HasParentRef())
            {
                ((SharedCode.EntitySystem.IDeltaObjectExt)_AccountTypes)?.DecrementParentRefs();
            }
        }
        ...
        protected override void Subscribe(string propertyName, SharedCode.EntitySystem.PropertyChangedDelegate callback)
        {
            ...
            {
                case "AccountTypes":
                    AccountTypes__Changed += callback;
                    break;
                default:
        ...
        protected override void FireEvents(System.Collections.Generic.List<System.Func<System.Threading.Tasks.Task>> container)
        {
            ...
            if (NeedFireEvent(10) && AccountTypes__Changed != null)
            {
                ...
                var __Event__Args__ = new SharedCode.EntitySystem.EntityEventArgs(_AccountTypes, nameof(AccountTypes), __propAddress__, this);
                GeneratedCode.EntitySystem.EventHelper.FireEvent(container, __Event__Args__, AccountTypes__Changed);
            }
        }
        ...
        public override void Downgrade(long mask)
        {
            ...
            if (_AccountTypes != null)
                ((SharedCode.EntitySystem.IDeltaObjectExt)_AccountTypes).Downgrade(mask);
        }
    }
}