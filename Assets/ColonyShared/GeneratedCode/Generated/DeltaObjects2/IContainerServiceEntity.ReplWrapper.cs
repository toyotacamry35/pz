...
namespace GeneratedCode.DeltaObjects
{
    public partial class ContainerServiceEntity
    {
        ...
        private ContainerServiceEntityAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ContainerServiceEntityAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new ContainerServiceEntityAlways(this);
                return _Always_Wrap;
            }
        }

        private ContainerServiceEntityClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ContainerServiceEntityClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new ContainerServiceEntityClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private ContainerServiceEntityClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ContainerServiceEntityClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new ContainerServiceEntityClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private ContainerServiceEntityClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ContainerServiceEntityClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new ContainerServiceEntityClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private ContainerServiceEntityServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ContainerServiceEntityServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new ContainerServiceEntityServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private ContainerServiceEntityServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ContainerServiceEntityServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new ContainerServiceEntityServer(this);
                return _Server_Wrap;
            }
        }
    }
