...
namespace GeneratedCode.DeltaObjects
{
    public partial class CharacterChest
    {
        ...
        private CharacterChestAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CharacterChestAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new CharacterChestAlways(this);
                return _Always_Wrap;
            }
        }

        private CharacterChestClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CharacterChestClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new CharacterChestClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private CharacterChestClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CharacterChestClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new CharacterChestClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private CharacterChestClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CharacterChestClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new CharacterChestClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private CharacterChestServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CharacterChestServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new CharacterChestServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private CharacterChestServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public CharacterChestServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new CharacterChestServer(this);
                return _Server_Wrap;
            }
        }
    }
