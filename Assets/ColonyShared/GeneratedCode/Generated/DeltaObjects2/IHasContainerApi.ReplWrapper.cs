...
namespace GeneratedCode.DeltaObjects
{
    public partial class ContainerApi
    {
        ...
        private ContainerApiAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ContainerApiAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new ContainerApiAlways(this);
                return _Always_Wrap;
            }
        }

        private ContainerApiClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ContainerApiClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new ContainerApiClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private ContainerApiClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ContainerApiClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new ContainerApiClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private ContainerApiClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ContainerApiClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new ContainerApiClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private ContainerApiServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ContainerApiServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new ContainerApiServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private ContainerApiServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public ContainerApiServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new ContainerApiServer(this);
                return _Server_Wrap;
            }
        }
    }
