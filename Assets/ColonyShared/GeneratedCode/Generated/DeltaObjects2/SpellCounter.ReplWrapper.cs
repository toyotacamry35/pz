...
namespace GeneratedCode.DeltaObjects
{
    public partial class SpellCounter
    {
        ...
        private SpellCounterAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public SpellCounterAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new SpellCounterAlways(this);
                return _Always_Wrap;
            }
        }

        private SpellCounterClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public SpellCounterClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new SpellCounterClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private SpellCounterClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public SpellCounterClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new SpellCounterClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private SpellCounterClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public SpellCounterClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new SpellCounterClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private SpellCounterServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public SpellCounterServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new SpellCounterServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private SpellCounterServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public SpellCounterServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new SpellCounterServer(this);
                return _Server_Wrap;
            }
        }
    }
