...
namespace GeneratedCode.DeltaObjects
{
    public partial class LegionaryEntity
    {
        ...
        private LegionaryEntityAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public LegionaryEntityAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new LegionaryEntityAlways(this);
                return _Always_Wrap;
            }
        }

        private LegionaryEntityClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public LegionaryEntityClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new LegionaryEntityClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private LegionaryEntityClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public LegionaryEntityClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new LegionaryEntityClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private LegionaryEntityClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public LegionaryEntityClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new LegionaryEntityClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private LegionaryEntityServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public LegionaryEntityServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new LegionaryEntityServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private LegionaryEntityServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public LegionaryEntityServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new LegionaryEntityServer(this);
                return _Server_Wrap;
            }
        }
    }
