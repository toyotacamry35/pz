...
namespace GeneratedCode.DeltaObjects
{
    ...
    {
        [SharedCode.EntitySystem.RpcClassHashAttribute(-438076436)]
        internal static class ReceiveFuncs
        {
            [SharedCode.EntitySystem.RpcMethodReceiverFunc(0, "ISessionResult_Clear__Message")]
            internal static async void ISessionResult_Clear__Message_Func(IEntitiesRepository _repository, INetworkProxy networkProxy, Guid callback, byte[] __data__, int __offset__, PropertyAddress __propertyAddress__, IDeltaObject __targetObj__, Guid __transactionId__, Guid __migrationId__)
            {
                try
                {
                    ...
                    using (GeneratedCode.Manual.AsyncStack.AsyncStackIsolator.IsolateContext())
                    {
                        ...
                        using (await __task)
                        {
                            var __entity__ = __targetObj__.To<SharedCode.Entities.ISessionResult>();
                            result = await __entity__.Clear();
                        }
                    }
                    ...
                    try
                    {
                        ...
                        GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcNetworkStatistics>.Instance.SentResponseBytes(typeof(SharedCode.Entities.ISessionResult), 0, offset);
                ...
                {
                    RpcHelper.CheckAndSendTransactionException(networkProxy, __transactionId__, typeof(SharedCode.Entities.ISessionResult), 0, __propertyAddress__, e, ref __migrationId__);
