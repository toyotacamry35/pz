...
namespace GeneratedCode.DeltaObjects
{
    public partial class PlaceObjectCounter
    {
        ...
        private PlaceObjectCounterAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public PlaceObjectCounterAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new PlaceObjectCounterAlways(this);
                return _Always_Wrap;
            }
        }

        private PlaceObjectCounterClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public PlaceObjectCounterClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new PlaceObjectCounterClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private PlaceObjectCounterClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public PlaceObjectCounterClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new PlaceObjectCounterClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private PlaceObjectCounterClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public PlaceObjectCounterClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new PlaceObjectCounterClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private PlaceObjectCounterServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public PlaceObjectCounterServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new PlaceObjectCounterServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private PlaceObjectCounterServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public PlaceObjectCounterServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new PlaceObjectCounterServer(this);
                return _Server_Wrap;
            }
        }
    }
