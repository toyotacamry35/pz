...
{
    public interface IValueStatImplementRemoteMethods
    {
        System.Threading.Tasks.ValueTask<bool> ChangeValueImpl(float delta);
        System.Threading.Tasks.ValueTask CopyImpl(Src.Aspects.Impl.Stats.IValueStat valueStat);
