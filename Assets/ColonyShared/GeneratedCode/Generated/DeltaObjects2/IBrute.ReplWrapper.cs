...
namespace GeneratedCode.DeltaObjects
{
    public partial class Brute
    {
        ...
        private BruteAlways _Always_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public BruteAlways Always_Wrap
        {
            get
            {
                if (_Always_Wrap == null)
                    _Always_Wrap = new BruteAlways(this);
                return _Always_Wrap;
            }
        }

        private BruteClientBroadcast _ClientBroadcast_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public BruteClientBroadcast ClientBroadcast_Wrap
        {
            get
            {
                if (_ClientBroadcast_Wrap == null)
                    _ClientBroadcast_Wrap = new BruteClientBroadcast(this);
                return _ClientBroadcast_Wrap;
            }
        }

        private BruteClientFullApi _ClientFullApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public BruteClientFullApi ClientFullApi_Wrap
        {
            get
            {
                if (_ClientFullApi_Wrap == null)
                    _ClientFullApi_Wrap = new BruteClientFullApi(this);
                return _ClientFullApi_Wrap;
            }
        }

        private BruteClientFull _ClientFull_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public BruteClientFull ClientFull_Wrap
        {
            get
            {
                if (_ClientFull_Wrap == null)
                    _ClientFull_Wrap = new BruteClientFull(this);
                return _ClientFull_Wrap;
            }
        }

        private BruteServerApi _ServerApi_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public BruteServerApi ServerApi_Wrap
        {
            get
            {
                if (_ServerApi_Wrap == null)
                    _ServerApi_Wrap = new BruteServerApi(this);
                return _ServerApi_Wrap;
            }
        }

        private BruteServer _Server_Wrap;
        [ProtoIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public BruteServer Server_Wrap
        {
            get
            {
                if (_Server_Wrap == null)
                    _Server_Wrap = new BruteServer(this);
                return _Server_Wrap;
            }
        }
    }
