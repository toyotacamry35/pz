...
namespace GeneratedCode.DeltaObjects
{
    ...
    {
        public Task AddPerkSlot(int slotId, SharedCode.Aspects.Item.Templates.ItemTypeResource perkSlotType)
        {
            this.CheckValidateEntityInAsyncContext();
            if (this.IsMaster())
                if (this.NeedDeferredRpcOnMigrating())
                    return AddPerkSlotRunMaster(slotId, perkSlotType).AsTask();
                else
                    return AddPerkSlotRun(slotId, perkSlotType).AsTask();
            else
                return SendFuncs.AddPerkSlot(slotId, perkSlotType, this, this.GetNetworkProxyForSerialization(), this.EntitiesRepository, GetActualMigratingId()).AsTask();
        }

        private Func<Task> AddPerkSlotCreateDeferredDelegate(int slotId, SharedCode.Aspects.Item.Templates.ItemTypeResource perkSlotType) => () =>
        {
            return AddPerkSlot(slotId, perkSlotType);
        }

        ;
        public async ValueTask AddPerkSlotRunMaster(int slotId, SharedCode.Aspects.Item.Templates.ItemTypeResource perkSlotType)
        {
            if (parentEntity != null)
            {
                ...
                if (__checkTask__.Result)
                    await ((IEntityExt)parentEntity).AddDeferredMigratingRpc(AddPerkSlotCreateDeferredDelegate(slotId, perkSlotType), nameof(AddPerkSlot));
            }

            await AddPerkSlotRun(slotId, perkSlotType);
        }

        public async ValueTask AddPerkSlotRun(int slotId, SharedCode.Aspects.Item.Templates.ItemTypeResource perkSlotType)
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ITemporaryPerks), 0);
            ...
            using (wrapper)
            {
                ...
                try
                {
                    var returnTask = AddPerkSlotImpl(slotId, perkSlotType);
        ...
        public Task RemovePerkSlot(int slotId)
        {
            this.CheckValidateEntityInAsyncContext();
            if (this.IsMaster())
                if (this.NeedDeferredRpcOnMigrating())
                    return RemovePerkSlotRunMaster(slotId).AsTask();
                else
                    return RemovePerkSlotRun(slotId).AsTask();
            else
                return SendFuncs.RemovePerkSlot(slotId, this, this.GetNetworkProxyForSerialization(), this.EntitiesRepository, GetActualMigratingId()).AsTask();
        }

        private Func<Task> RemovePerkSlotCreateDeferredDelegate(int slotId) => () =>
        {
            return RemovePerkSlot(slotId);
        }

        ;
        public async ValueTask RemovePerkSlotRunMaster(int slotId)
        {
            if (parentEntity != null)
            {
                var __checkTask__ = ((IEntityExt)parentEntity).NeedPutToDeferredRpcQueue();
                if (!__checkTask__.IsCompleted)
                    await __checkTask__;
                if (__checkTask__.Result)
                    await ((IEntityExt)parentEntity).AddDeferredMigratingRpc(RemovePerkSlotCreateDeferredDelegate(slotId), nameof(RemovePerkSlot));
            }

            await RemovePerkSlotRun(slotId);
        }

        public async ValueTask RemovePerkSlotRun(int slotId)
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ITemporaryPerks), 1);
            var getTask = this.GetThisExclusive();
            var wrapper = getTask.IsCompleted ? getTask.Result : await getTask;
            using (wrapper)
            {
                if (wrapper == null && EntitiesRepository != null)
                    throw new Exception($"{nameof(RemovePerkSlot)} GetExclusive wrapper is null");
                GeneratedCode.Manual.Repositories.RpcCurrentObject.ThisObj = this;
                Guid __oldMigrationId__ = default;
                var __needSetMigrationgId__ = MigratingId != Guid.Empty;
                if (__needSetMigrationgId__)
                ...
                try
                {
                    var returnTask = RemovePerkSlotImpl(slotId);
                    if (!returnTask.IsCompleted || returnTask.IsFaulted)
                    {
                        var __needDecrement__ = IncrementExecutedMethodsCounter(out var __parentEntity__);
                        try
        ...
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ITemporaryPerks), 2);
            Guid __oldMigrationId__ = default;
            var __needSetMigrationgId__ = MigratingId != Guid.Empty;
            if (__needSetMigrationgId__)
            {
        ...
        {
            this.CheckValidateEntityInAsyncContext();
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ITemporaryPerks), 3);
            Guid __oldMigrationId__ = default;
            var __needSetMigrationgId__ = MigratingId != Guid.Empty;
            if (__needSetMigrationgId__)
            {
        ...
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ITemporaryPerks), 4);
            Guid __oldMigrationId__ = default;
            var __needSetMigrationgId__ = MigratingId != Guid.Empty;
            if (__needSetMigrationgId__)
            {
        ...
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ITemporaryPerks), 5);
            Guid __oldMigrationId__ = default;
            var __needSetMigrationgId__ = MigratingId != Guid.Empty;
            if (__needSetMigrationgId__)
            {
        ...
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ITemporaryPerks), 6);
            Guid __oldMigrationId__ = default;
            var __needSetMigrationgId__ = MigratingId != Guid.Empty;
            if (__needSetMigrationgId__)
            {
        ...
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ITemporaryPerks), 7);
        ...
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ITemporaryPerks), 8);
            global::GeneratedCode.Manual.Repositories.RpcCurrentObject.ThisObj = this;
            Guid __oldMigrationId__ = default;
            var __needSetMigrationgId__ = MigratingId != Guid.Empty;
            if (__needSetMigrationgId__)
        ...
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ITemporaryPerks), 9);
            var getTask = this.GetThisExclusive();
            var wrapper = getTask.IsCompleted ? getTask.Result : await getTask;
            using (wrapper)
            {
        ...
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ITemporaryPerks), 10);
            var getTask = this.GetThisExclusive();
            var wrapper = getTask.IsCompleted ? getTask.Result : await getTask;
            using (wrapper)
            {
        ...
        public async Task OnItemAddedToContainer(SharedCode.Aspects.Item.Templates.BaseItemResource arg1, int arg2, int arg3, bool arg4)
        {
            if (this.IsMaster())
            {
                GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ITemporaryPerks), 11);
                INetworkProxy[] __networkProxies__ = this.GatherMessageTargets(SharedCode.EntitySystem.ReplicationLevel.ClientFull, typeof(SharedCode.DeltaObjects.ITemporaryPerks), 11).ToArray();
        ...
        public async Task OnItemRemovedToContainer(SharedCode.Aspects.Item.Templates.BaseItemResource arg1, int arg2, int arg3, bool arg4)
        {
            if (this.IsMaster())
            {
                GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ITemporaryPerks), 12);
                INetworkProxy[] __networkProxies__ = this.GatherMessageTargets(SharedCode.EntitySystem.ReplicationLevel.ClientFull, typeof(SharedCode.DeltaObjects.ITemporaryPerks), 12).ToArray();
                if (__networkProxies__.Length > 0)
...
namespace GeneratedCode.DeltaObjects
{
    public partial class PermanentPerks
    {
        ...
        public async ValueTask AddPerkSlotRun(int slotId, SharedCode.Aspects.Item.Templates.ItemTypeResource perkSlotType)
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.IPermanentPerks), 0);
            var getTask = this.GetThisExclusive();
            var wrapper = getTask.IsCompleted ? getTask.Result : await getTask;
            using (wrapper)
            {
        ...
        public async ValueTask RemovePerkSlotRun(int slotId)
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.IPermanentPerks), 1);
            var getTask = this.GetThisExclusive();
            var wrapper = getTask.IsCompleted ? getTask.Result : await getTask;
            using (wrapper)
            {
        ...
        public async Task<float> GetMaxWeigthRun()
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.IPermanentPerks), 2);
            Guid __oldMigrationId__ = default;
            var __needSetMigrationgId__ = MigratingId != Guid.Empty;
            if (__needSetMigrationgId__)
            {
        ...
        {
            this.CheckValidateEntityInAsyncContext();
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.IPermanentPerks), 3);
            Guid __oldMigrationId__ = default;
            var __needSetMigrationgId__ = MigratingId != Guid.Empty;
            if (__needSetMigrationgId__)
            {
        ...
        public async Task<int> GetMaxStackForSlotRun(int destinationSlot)
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.IPermanentPerks), 4);
            Guid __oldMigrationId__ = default;
            var __needSetMigrationgId__ = MigratingId != Guid.Empty;
            if (__needSetMigrationgId__)
            {
        ...
        public async Task<bool> IgnoreMaxStackRun()
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.IPermanentPerks), 5);
            Guid __oldMigrationId__ = default;
            var __needSetMigrationgId__ = MigratingId != Guid.Empty;
            if (__needSetMigrationgId__)
            {
        ...
        public async Task<bool> CanAutoselectEmptySlotsForAddStacksRun()
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.IPermanentPerks), 6);
            Guid __oldMigrationId__ = default;
            var __needSetMigrationgId__ = MigratingId != Guid.Empty;
            if (__needSetMigrationgId__)
            {
        ...
        public async ValueTask<bool> CanAddRun(SharedCode.Entities.IItem item, int index, int count, bool manual)
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.IPermanentPerks), 7);
            global::GeneratedCode.Manual.Repositories.RpcCurrentObject.ThisObj = this;
            Guid __oldMigrationId__ = default;
            var __needSetMigrationgId__ = MigratingId != Guid.Empty;
            if (__needSetMigrationgId__)
        ...
        public async ValueTask<bool> CanRemoveRun(SharedCode.Entities.IItem item, int index, int count, bool manual)
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.IPermanentPerks), 8);
            global::GeneratedCode.Manual.Repositories.RpcCurrentObject.ThisObj = this;
            Guid __oldMigrationId__ = default;
            var __needSetMigrationgId__ = MigratingId != Guid.Empty;
            if (__needSetMigrationgId__)
        ...
        public async ValueTask OnItemAddedRun(SharedCode.Entities.IItem item, int index, int count, bool manual)
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.IPermanentPerks), 9);
            var getTask = this.GetThisExclusive();
            var wrapper = getTask.IsCompleted ? getTask.Result : await getTask;
            using (wrapper)
            {
        ...
        public async ValueTask<SharedCode.EntitySystem.PropertyAddress> OnBeforeItemRemovedRun(SharedCode.Entities.IItem item, int index, int count, bool manual)
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.IPermanentPerks), 10);
            var getTask = this.GetThisExclusive();
            var wrapper = getTask.IsCompleted ? getTask.Result : await getTask;
            using (wrapper)
            {
        ...
        public async Task OnItemAddedToContainer(SharedCode.Aspects.Item.Templates.BaseItemResource arg1, int arg2, int arg3, bool arg4)
        {
            if (this.IsMaster())
            {
                GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.IPermanentPerks), 11);
                INetworkProxy[] __networkProxies__ = this.GatherMessageTargets(SharedCode.EntitySystem.ReplicationLevel.ClientFull, typeof(SharedCode.DeltaObjects.IPermanentPerks), 11).ToArray();
                if (__networkProxies__.Length > 0)
                    await SendFuncs.OnItemAddedToContainer(arg1, arg2, arg3, arg4, this, __networkProxies__, this.EntitiesRepository, GetActualMigratingId());
            }
        ...
        public async Task OnItemRemovedToContainer(SharedCode.Aspects.Item.Templates.BaseItemResource arg1, int arg2, int arg3, bool arg4)
        {
            if (this.IsMaster())
            {
                GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.IPermanentPerks), 12);
                INetworkProxy[] __networkProxies__ = this.GatherMessageTargets(SharedCode.EntitySystem.ReplicationLevel.ClientFull, typeof(SharedCode.DeltaObjects.IPermanentPerks), 12).ToArray();
                if (__networkProxies__.Length > 0)
                    await SendFuncs.OnItemRemovedToContainer(arg1, arg2, arg3, arg4, this, __networkProxies__, this.EntitiesRepository, GetActualMigratingId());
            }
...
namespace GeneratedCode.DeltaObjects
{
    public partial class SavedPerks
    {
        ...
        public async ValueTask AddPerkSlotRun(int slotId, SharedCode.Aspects.Item.Templates.ItemTypeResource perkSlotType)
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ISavedPerks), 0);
            var getTask = this.GetThisExclusive();
            var wrapper = getTask.IsCompleted ? getTask.Result : await getTask;
            using (wrapper)
            {
        ...
        public async ValueTask RemovePerkSlotRun(int slotId)
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ISavedPerks), 1);
            var getTask = this.GetThisExclusive();
            var wrapper = getTask.IsCompleted ? getTask.Result : await getTask;
            using (wrapper)
            {
        ...
        public async Task<float> GetMaxWeigthRun()
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ISavedPerks), 2);
            Guid __oldMigrationId__ = default;
            var __needSetMigrationgId__ = MigratingId != Guid.Empty;
            if (__needSetMigrationgId__)
            {
        ...
        {
            this.CheckValidateEntityInAsyncContext();
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ISavedPerks), 3);
            Guid __oldMigrationId__ = default;
            var __needSetMigrationgId__ = MigratingId != Guid.Empty;
            if (__needSetMigrationgId__)
            {
        ...
        public async Task<int> GetMaxStackForSlotRun(int destinationSlot)
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ISavedPerks), 4);
            Guid __oldMigrationId__ = default;
            var __needSetMigrationgId__ = MigratingId != Guid.Empty;
            if (__needSetMigrationgId__)
            {
        ...
        public async Task<bool> IgnoreMaxStackRun()
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ISavedPerks), 5);
            Guid __oldMigrationId__ = default;
            var __needSetMigrationgId__ = MigratingId != Guid.Empty;
            if (__needSetMigrationgId__)
            {
        ...
        public async Task<bool> CanAutoselectEmptySlotsForAddStacksRun()
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ISavedPerks), 6);
            Guid __oldMigrationId__ = default;
            var __needSetMigrationgId__ = MigratingId != Guid.Empty;
            if (__needSetMigrationgId__)
            {
        ...
        public async ValueTask<bool> CanAddRun(SharedCode.Entities.IItem item, int index, int count, bool manual)
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ISavedPerks), 7);
            global::GeneratedCode.Manual.Repositories.RpcCurrentObject.ThisObj = this;
            Guid __oldMigrationId__ = default;
            var __needSetMigrationgId__ = MigratingId != Guid.Empty;
            if (__needSetMigrationgId__)
        ...
        public async ValueTask<bool> CanRemoveRun(SharedCode.Entities.IItem item, int index, int count, bool manual)
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ISavedPerks), 8);
            global::GeneratedCode.Manual.Repositories.RpcCurrentObject.ThisObj = this;
            Guid __oldMigrationId__ = default;
            var __needSetMigrationgId__ = MigratingId != Guid.Empty;
            if (__needSetMigrationgId__)
        ...
        public async ValueTask OnItemAddedRun(SharedCode.Entities.IItem item, int index, int count, bool manual)
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ISavedPerks), 9);
            var getTask = this.GetThisExclusive();
            var wrapper = getTask.IsCompleted ? getTask.Result : await getTask;
            using (wrapper)
            {
        ...
        public async ValueTask<SharedCode.EntitySystem.PropertyAddress> OnBeforeItemRemovedRun(SharedCode.Entities.IItem item, int index, int count, bool manual)
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ISavedPerks), 10);
            var getTask = this.GetThisExclusive();
            var wrapper = getTask.IsCompleted ? getTask.Result : await getTask;
            using (wrapper)
            {
        ...
        public async Task OnItemAddedToContainer(SharedCode.Aspects.Item.Templates.BaseItemResource arg1, int arg2, int arg3, bool arg4)
        {
            if (this.IsMaster())
            {
                GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ISavedPerks), 11);
                INetworkProxy[] __networkProxies__ = this.GatherMessageTargets(SharedCode.EntitySystem.ReplicationLevel.ClientFull, typeof(SharedCode.DeltaObjects.ISavedPerks), 11).ToArray();
                if (__networkProxies__.Length > 0)
                    await SendFuncs.OnItemAddedToContainer(arg1, arg2, arg3, arg4, this, __networkProxies__, this.EntitiesRepository, GetActualMigratingId());
            }
        ...
        public async Task OnItemRemovedToContainer(SharedCode.Aspects.Item.Templates.BaseItemResource arg1, int arg2, int arg3, bool arg4)
        {
            if (this.IsMaster())
            {
                GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.DeltaObjects.ISavedPerks), 12);
                INetworkProxy[] __networkProxies__ = this.GatherMessageTargets(SharedCode.EntitySystem.ReplicationLevel.ClientFull, typeof(SharedCode.DeltaObjects.ISavedPerks), 12).ToArray();
                if (__networkProxies__.Length > 0)
                    await SendFuncs.OnItemRemovedToContainer(arg1, arg2, arg3, arg4, this, __networkProxies__, this.EntitiesRepository, GetActualMigratingId());
            }
