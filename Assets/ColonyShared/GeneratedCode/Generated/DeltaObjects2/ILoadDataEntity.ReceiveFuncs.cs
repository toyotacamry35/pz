...
namespace GeneratedCode.DeltaObjects
{
    ...
    {
        [SharedCode.EntitySystem.RpcClassHashAttribute(-517327412)]
        internal static class ReceiveFuncs
        {
            [SharedCode.EntitySystem.RpcMethodReceiverFunc(0, "ILoadDataEntity_LoadEntity_Int32_Guid_Message")]
            internal static async void ILoadDataEntity_LoadEntity_Int32_Guid_Message_Func(IEntitiesRepository _repository, INetworkProxy networkProxy, Guid callback, byte[] __data__, int __offset__, PropertyAddress __propertyAddress__, IDeltaObject __targetObj__, Guid __transactionId__, Guid __migrationId__)
            {
                try
                {
                    ...
                    using (GeneratedCode.Manual.AsyncStack.AsyncStackIsolator.IsolateContext())
                    {
                        ...
                        using (await __task)
                        {
                            var __entity__ = __targetObj__.To<SharedCode.Entities.Cloud.ILoadDataEntity>();
                            result = await __entity__.LoadEntity(typeId, entityId);
                        }
                    }
                    ...
                    try
                    {
                        ...
                        GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcNetworkStatistics>.Instance.SentResponseBytes(typeof(SharedCode.Entities.Cloud.ILoadDataEntity), 0, offset);
                ...
                {
                    RpcHelper.CheckAndSendTransactionException(networkProxy, __transactionId__, typeof(SharedCode.Entities.Cloud.ILoadDataEntity), 0, __propertyAddress__, e, ref __migrationId__);
