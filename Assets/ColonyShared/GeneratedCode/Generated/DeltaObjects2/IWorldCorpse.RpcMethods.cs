...
namespace GeneratedCode.DeltaObjects
{
    public partial class WorldCorpse
    {
        ...
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.Entities.IWorldCorpse), 0);
        ...
        public ValueTask<bool> MustBeInstantiatedHere()
        {
            this.CheckValidateEntityInAsyncContext();
            if (this.NeedDeferredRpcOnMigrating())
                return MustBeInstantiatedHereRunMaster();
            else
                return MustBeInstantiatedHereRun();
        }

        private Func<Task<bool>> MustBeInstantiatedHereCreateDeferredDelegate() => () =>
        {
            return MustBeInstantiatedHere().AsTask();
        }

        ;
        public async ValueTask<bool> MustBeInstantiatedHereRunMaster()
        {
            if (parentEntity != null)
            {
                var __checkTask__ = ((IEntityExt)parentEntity).NeedPutToDeferredRpcQueue();
                if (!__checkTask__.IsCompleted)
                    await __checkTask__;
                if (__checkTask__.Result)
                    return await ((IEntityExt)parentEntity).AddDeferredMigratingRpc(MustBeInstantiatedHereCreateDeferredDelegate(), nameof(MustBeInstantiatedHere));
            }

            return await MustBeInstantiatedHereRun();
        }

        public async ValueTask<bool> MustBeInstantiatedHereRun()
        {
            this.CheckValidateEntityInAsyncContext();
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.Entities.IWorldCorpse), 1);
            Guid __oldMigrationId__ = default;
            var __needSetMigrationgId__ = MigratingId != Guid.Empty;
            if (__needSetMigrationgId__)
            {
            ...
            try
            {
                ...
                try
                {
                    return await MustBeInstantiatedHereImpl();
                }
                finally
                {
                    ((IEntityExt)__parentEntity__)?.DecrementExecutedMethodsCounter(__needDecrement__);
        ...
        public ValueTask<Assets.ColonyShared.SharedCode.ResourcesSystem.Base.UnityRef<UnityEngine.GameObject>> GetPrefab()
        {
            this.CheckValidateEntityInAsyncContext();
            if (this.NeedDeferredRpcOnMigrating())
                return GetPrefabRunMaster();
            else
                return GetPrefabRun();
        }

        private Func<Task<Assets.ColonyShared.SharedCode.ResourcesSystem.Base.UnityRef<UnityEngine.GameObject>>> GetPrefabCreateDeferredDelegate() => () =>
        {
            return GetPrefab().AsTask();
        }

        ;
        public async ValueTask<Assets.ColonyShared.SharedCode.ResourcesSystem.Base.UnityRef<UnityEngine.GameObject>> GetPrefabRunMaster()
        {
            if (parentEntity != null)
            {
                var __checkTask__ = ((IEntityExt)parentEntity).NeedPutToDeferredRpcQueue();
                if (!__checkTask__.IsCompleted)
                    await __checkTask__;
                if (__checkTask__.Result)
                    return await ((IEntityExt)parentEntity).AddDeferredMigratingRpc(GetPrefabCreateDeferredDelegate(), nameof(GetPrefab));
            }

            return await GetPrefabRun();
        }

        public async ValueTask<Assets.ColonyShared.SharedCode.ResourcesSystem.Base.UnityRef<UnityEngine.GameObject>> GetPrefabRun()
        {
            this.CheckValidateEntityInAsyncContext();
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.Entities.IWorldCorpse), 2);
            Guid __oldMigrationId__ = default;
            var __needSetMigrationgId__ = MigratingId != Guid.Empty;
            if (__needSetMigrationgId__)
            {
        ...
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.Entities.IWorldCorpse), 3);
            var getTask = this.GetThisExclusive();
            var wrapper = getTask.IsCompleted ? getTask.Result : await getTask;
            using (wrapper)
            {
        ...
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.Entities.IWorldCorpse), 4);
            var getTask = this.GetThisExclusive();
            var wrapper = getTask.IsCompleted ? getTask.Result : await getTask;
            using (wrapper)
            {
        ...
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.Entities.IWorldCorpse), 5);
            var getTask = this.GetThisExclusive();
            var wrapper = getTask.IsCompleted ? getTask.Result : await getTask;
            using (wrapper)
            {
        ...
        {
            GeneratedCode.Network.Statistic.Statistics<GeneratedCode.Network.Statistic.RpcInnerStatistics>.Instance.Used(typeof(SharedCode.Entities.IWorldCorpse), 6);
            var getTask = this.GetThisExclusive();
            var wrapper = getTask.IsCompleted ? getTask.Result : await getTask;
            using (wrapper)
            {
