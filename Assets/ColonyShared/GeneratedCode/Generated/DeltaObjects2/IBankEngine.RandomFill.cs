...
namespace GeneratedCode.DeltaObjects
{
    public partial class BankEngine
    {
        protected override void RandomFill(int __count__, System.Random __random__, bool __withReadOnly__)
        {
            ...
            {
                var BankDef__rnd = ((ResourcesSystem.Loader.IGameResourcesRandomExtension)ResourcesSystem.Loader.GameResourcesHolder.Instance).LoadRandomResourceByType<Assets.ResourceSystem.Aspects.Banks.BankDef>(__random__);
                BankDef = BankDef__rnd;
            }
        }
    }
}