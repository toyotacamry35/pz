...
{
    public class SelectEventSource : TargetSelector
    {
        ...
        {
            var leg = HostStrategy.HostEvent.Initiator;
            if (leg.IsValid)
                return leg;
            else
                return null;
        ...
        {
            return targetLegionary.IsValid && targetLegionary == ((SpellCastEvent)HostStrategy.HostEvent).Initiator;
        }
    }
}
