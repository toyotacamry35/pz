...
namespace GameObjectBrush
{
    ...
    public class BrushCollection : ScriptableObject
    {
        ...
        private static string[] allBrushCollectionGUIDs = null;
        public static void ClearAllBrushCollectionGUIDsCache()
        {
            allBrushCollectionGUIDs = null;
        }
        public static string[] GetAllBrushCollectionGUIDs()
        {
            if (allBrushCollectionGUIDs == null)
            {
                allBrushCollectionGUIDs = AssetDatabase.FindAssets("t:BrushCollection");
            }
            return allBrushCollectionGUIDs;
        }
        /// <summary>
