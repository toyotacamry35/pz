...
#ifdef A_SECONDARY_TEXTURES_ON
	ASplatContext sc = aNewSplatContext(s, 1.0h, 1.0f);
	ASplat sp = aNewSplatWorld(s.positionWorld.xyz, s.normalWorld.xyz, sc, A_SAMPLER_2D_INPUT(_MainTex2), _MaterialMap2, _BumpMap2, _Color2, _BaseColorVertexTint2, _Metallic2, _Specularity2, _SpecularTint2, _Roughness2, _Occlusion2, _BumpScale2);
