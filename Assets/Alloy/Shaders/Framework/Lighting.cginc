...
void aBlendRangeMaskWorld(inout ASurface s, half mask, half weight, half cutoff, half blendRange, half vertexTint);
...
void aUpdateViewDataBlend(inout ASurface s);
