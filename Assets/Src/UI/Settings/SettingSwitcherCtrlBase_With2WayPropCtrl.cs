...
namespace Uins.Settings
{
    ...
    public abstract class SettingSwitcherCtrlBase_With2WayPropCtrl<TVM,TVal> : BindingController<TVM>, ISettingSwitcherCtrlBase where TVM : SettingSwitcherImplementationBase<TVal>
    {
        ...
        [Binding]
        public TVal BindingProp
        {
            //get => _2WayPropController?.Value ?? DfltVal;
            get =>
                (_2WayPropController != null && _2WayPropController.Value != null) 
                    ? _2WayPropController.Value 
                    : DfltVal;
            set => _2WayPropController?.OnChange(value);
        }
        ...
        private void Awake()
        {
            ...
            {
                //if (DbgLog.Enabled) DbgLog.Log($"SeSwCtBa: transformedInStream.Func: ({val})");
            ...
            _2WayPropController = new TwoWayPropController<TVal, SettingSwitcherCtrlBase_With2WayPropCtrl<TVM, TVal>>(() => BindingProp, this);
            _2WayPropController.Connect(transformedInStream,
                newValue => { 
    ...
    public interface ISettingSwitcherCtrlBase : IApplyableCancelableDefaultableCanBeChanged
    {
    }
}
