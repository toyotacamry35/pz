...
{
    internal class MobStatePathLanding : StateBase<CommonStateMachineContext>
    {
        public override void Execute(CommonStateMachineContext ctx, VariablesPipeline pipeline)
        {
            pipeline.ApplyFlags(LocomotionFlags.Airborne | LocomotionFlags.Landing /*| LocomotionFlags.FollowPath*/)
                .ApplyGravity(
