...
namespace UnityWeld.Binding.Adapters
{
    ...
    /// </summary>
    [CreateAssetMenu(menuName = "Unity Weld/Adapter options/Float to string with limit")]
    [HelpURL("https://github.com/Real-Serious-Games/Unity-Weld")]
    public class FloatToStringWithLimitAdapterOptions : AdapterOptions
    {
        /// <summary>
