...
namespace UnityWeld.Binding
{
    ...
    public class CollectionBinding : AbstractTemplateSelector
    {
        ...
        private void BindCollection()
        {
            ...
            if (!ParseEndPointReference(viewModelPropertyName, out propertyName, out viewModelName))
            {
                var msg = $"{nameof(ParseEndPointReference)}({nameof(viewModelPropertyName)}='{viewModelPropertyName}') is failed";
