...
namespace UnityWeld.Binding
{
    ...
    public class TwoWayPropertyBinding : AbstractMemberBinding
    {
        ...
        public override void Connect()
        {
            ...
            if (!ParseEndPointReference(uiEventName, out eventName, out eventComponentType))
            {
                var msg = $"{nameof(ParseEndPointReference)}({nameof(uiEventName)}='{uiEventName}') is failed";
