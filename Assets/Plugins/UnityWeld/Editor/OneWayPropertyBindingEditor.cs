...
namespace UnityWeld_Editor
{
    ...
    class OneWayPropertyBindingEditor : BaseBindingEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            SerializedProperty sprop = serializedObject.FindProperty("DontFindViewModelOnAwake");
            EditorGUILayout.PropertyField(sprop);
            serializedObject.ApplyModifiedProperties(); //TODO поменять на обн. отд. свойства, как везде
