    ...
    public class Decal : MonoBehaviour
    {
        ...
        private void SetMeshFilter()
        {
            ...
            if (mf.sharedMesh == null)
                mf.sharedMesh = UnityEditor.AssetDatabase.LoadAssetAtPath<Mesh>("Assets/Plugins/Decalicious/Resources/DecalCube.asset");
        }
#endif
        ...
        private void SetRenderMode()
        {
            ...
            else if (Material.shader.name.Contains(_deferredShaderName))
                RenderMode = DecalRenderMode.Deferred;
            else if (Material.shader.name.Contains(_unlitShaderName))
