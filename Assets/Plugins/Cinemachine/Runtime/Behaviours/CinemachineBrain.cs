...
//    [RequireComponent(typeof(Camera))] // strange but true: we can live without it
    ...
    public class CinemachineBrain : MonoBehaviour
    {
            ...
            ICinemachineCamera fromKey, ICinemachineCamera toKey)
        {
            ...
            {
                string fromCameraName = (fromKey != null && fromKey as Component) ? fromKey.Name : string.Empty;
                string toCameraName = (toKey != null && fromKey as Component) ? toKey.Name : string.Empty;
        ...
        private void PushStateToUnityCamera(CameraState state)
        {
            ...
            if(Logger.IsTraceEnabled) 
            {
                ...
                Logger.Trace($"Cinemachine | Frame:{Time.frameCount} Forward:({forward.x:F4}, {forward.y:F4})");
            }
