            ...
            else
            {
                ...
                switch (m_xmlAttribute[0].nameHashCode)
                {
                    ...
                    case 28511: // <FONT>
                        ...
                        {
                            // Load Font Asset
                            tempFont = Profile.Load<TMP_FontAsset>(TMP_Settings.defaultFontAssetPath + new string(m_htmlTag, m_xmlAttribute[0].valueStartIndex, m_xmlAttribute[0].valueLength));
                        ...
                        else if (materialAttributeHashCode == 103415287 || materialAttributeHashCode == 72669687) // using material attribute
                        {
                            ...
                            {
                                // Load new material
                                tempMaterial = Profile.Load<Material>(TMP_Settings.defaultFontAssetPath + new string(m_htmlTag, m_xmlAttribute[1].valueStartIndex, m_xmlAttribute[1].valueLength));
                    ...
                    case 72669687: // <MATERIAL>
                        ...
                        {
                            // Load new material
                            tempMaterial = Profile.Load<Material>(TMP_Settings.defaultFontAssetPath + new string(m_htmlTag, m_xmlAttribute[0].valueStartIndex, m_xmlAttribute[0].valueLength));
                    ...
                    case 1619421: // <SPRITE>
                        ...
                        if (m_xmlAttribute[0].valueType == TagType.None || m_xmlAttribute[0].valueType == TagType.NumericalValue)
                        {
                            ...
                            else if (m_defaultSpriteAsset == null)
                            {
                                if (TMP_Settings.defaultSpriteAsset != null)
                                    ...
                                    m_defaultSpriteAsset = Profile.Load<TMP_SpriteAsset>("Sprite Assets/Default Sprite Asset");
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    tempSpriteAsset = Profile.Load<TMP_SpriteAsset>(TMP_Settings.defaultSpriteAssetPath + new string(m_htmlTag, m_xmlAttribute[0].valueStartIndex, m_xmlAttribute[0].valueLength));
                                }
