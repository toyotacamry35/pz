    ...
    public class GrassPatchGenerator : MonoBehaviour
    {
        ...
        private void Reset()
        {
            ...
            if (GrassTexture == null)
            {
                ...
                GrassTexture = AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/Plugins/AwesomeTechnologies/VegetationStudio/Common/_Resources/GrassTextures/GrassFrond01.psd");
        ...
        public void UpdateTexture()
        {
            if (CustomMaterial == null)
            {
                ...
                material.SetTexture("_AG_ColorNoiseTex", AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/Plugins/AwesomeTechnologies/VegetationStudio/Common/_Resources/PerlinSeamless.png"));
        ...
        {
            _vertexColorMaterial = AssetDatabase.LoadAssetAtPath<Material>("Assets/Plugins/AwesomeTechnologies/VegetationStudio/GrassSystem/_Resources/GrassPatchVertexColor.mat");
