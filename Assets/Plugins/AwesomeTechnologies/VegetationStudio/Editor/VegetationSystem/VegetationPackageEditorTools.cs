...
public class VegetationPackageEditorTools
{
    ...
    {
        //AssetPreview.SetPreviewTextureCacheSize(vegetationPackage.VegetationInfoList.Count);
        ...
        for (int i = 0; i <= vegetationInfoIdList.Count - 1; i++)
        {
            ...
            imageButtons[i] = new GUIContent
            {
                image = (Texture)AssetPreview.GetAssetPreview(vegetationItemInfo.VegetationPrefab)
            };
    ...
    public static void DrawVegetationItemSelector(VegetationPackage vegetationPackage, ref int selectedGridIndex, ref int vegIndex, VegetationItemTypeSelection vegetationItemTypeSelection, int imageSize)
    {
        ...
        for (int i = 0; i <= vegetationItemIndexList.Count - 1; i++)
        {
             imageButtons[i] = new GUIContent
             {
                image = (Texture)AssetPreview.GetAssetPreview(vegetationPackage.VegetationInfoList[vegetationItemIndexList[i]].VegetationPrefab)
             };
        }
