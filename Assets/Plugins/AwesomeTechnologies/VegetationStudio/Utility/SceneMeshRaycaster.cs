...
namespace AwesomeTechnologies.Utility
{
    ...
    public class SceneMeshRaycaster
    {
        ...
        {
#if UNITY_EDITOR
            var editorTypes = typeof(Editor).Assembly.GetTypesSafe();
        ...
        public bool RaycastCurrenMesh(Ray ray, out RaycastHit hit, MeshRendererRaycastInfo info)
        {
            hit = new RaycastHit();
            ...
            Handles.DrawWireCube(info.Bounds.center, info.Bounds.size);
#endif
            if (!IntersectRayMesh(ray, info.Mesh, info.LocalToWorldMatrix4X4, out tempRaycastHit)) return false;
