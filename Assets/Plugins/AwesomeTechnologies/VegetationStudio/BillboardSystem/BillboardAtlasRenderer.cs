...
namespace AwesomeTechnologies
{
    ...
    public class BillboardAtlasRenderer : MonoBehaviour
    {
            ...
            Color backgroundColor)
        {
            ...
            Material minPostfilter = Profile.Load<Material>("MinPostFilter/MinPostFilter");
        ...
        private static int GetBillboardQualityTileWidth(BillboardQuality billboardQuality)
        {
